// File Line: 50
// RVA: 0xB18B50
void __fastcall DSP::MixStereoWidth(
        float *io_pfIn1Out,
        float *io_pfIn2Out,
        int in_uNumFrames,
        float in_fPrevStereoWidth,
        float in_fStereoWidth)
{
  float v6; // xmm6_4
  float v7; // xmm4_4
  __m128 v8; // xmm2
    ...
    if ( io_pfIn1Out < v12 )
    {
      if ( ((char *)v12 - (char *)io_pfIn1Out + 3) / 4 >= 4 )
      {
        do
        {
          ...
          *(io_pfIn2Out - 1) = (float)(v24 * v6) + (float)(v27 * v10);
          *(io_pfIn1Out - 1) = (float)(v27 * v6) + (float)(v24 * v10);
        }
        while ( (__int64)io_pfIn1Out < (__int64)(v12 - 3) );
      }
      if ( io_pfIn1Out < v12 )
      {
        v28 = (char *)io_pfIn2Out - (char *)io_pfIn1Out;
        do
        {
          v29 = *io_pfIn1Out;
  ...
  else
  {
    ...
    if ( io_pfIn1Out < v32 )
    {
      if ( ((char *)v32 - (char *)io_pfIn1Out + 3) / 4 >= 4 )
      {
        ...
        while ( (__int64)io_pfIn1Out < (__int64)(v32 - 3) );
      }
      for ( ; io_pfIn1Out < v32; *(io_pfIn2Out - 1) = v71 + v74 )
      {
        v68 = *io_pfIn1Out;
        v69 = *io_pfIn2Out;
        ++io_pfIn1Out;
  ...
  else
  {
    ...
    if ( v9 < v36 )
    {
      if ( (4i64 * (unsigned int)in_uNumFrames + 3) / 4 >= 4 )
      {
        ...
        while ( (__int64)v9 < (__int64)(v36 - 3) );
      }
      if ( v9 < v36 )
      {
        v73 = (char *)in_pfIn2 - (char *)out_pfOut1;
...
void __fastcall DSP::MixStereoWidth(AkAudioBuffer *io_pBuffer, float in_fPrevStereoWidth, float in_fStereoWidth)
{
  ...
  if ( (uChannelMask & 0x30) != 0 )
  {
    ...
    if ( (uChannelMask & 4) != 0 )
      v6 = 3;
    DSP::MixStereoWidth(
      (float *)io_pBuffer->pData + io_pBuffer->uMaxFrames * (unsigned __int64)v6,
      (float *)io_pBuffer->pData + io_pBuffer->uMaxFrames * (unsigned __int64)(v6 + 1),
      uValidFrames,
      in_fPrevStereoWidth,
      in_fStereoWidth);
    if ( (uChannelMask & 0x600) != 0 )
      DSP::MixStereoWidth(
        (float *)io_pBuffer->pData + io_pBuffer->uMaxFrames * (unsigned __int64)(v6 + 2),
        (float *)io_pBuffer->pData + io_pBuffer->uMaxFrames * (unsigned __int64)(v6 + 3),
        uValidFrames,
        in_fPrevStereoWidth,
        in_fStereoWidth);
  }
