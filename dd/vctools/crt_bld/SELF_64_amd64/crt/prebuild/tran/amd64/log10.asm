...
double __cdecl log10(double X)
{
  ...
  v1 = X;
  *(_QWORD *)&v2 = *(_OWORD *)&_mm_cvtepi32_pd(_mm_sub_epi64(_mm_srli_epi64(*(__m128i *)&X, 0x34u), *(__m128i *)&_mask_1023_2));
  v3 = (__m128i)_mm_and_pd(*(__m128d *)&X, *(__m128d *)&_real_inf_5);
  if ( *(double *)v3.m128i_i64 != *(double *)&_real_inf_5 )
  {
    v4 = _mm_and_si128(*(__m128i *)&X, *(__m128i *)&_real_mant_3);
    if ( v2 == -1023.0 )
    {
      ...
      *(_QWORD *)&v2 = *(_OWORD *)&_mm_cvtepi32_pd(_mm_sub_epi32(_mm_srli_epi64(v3, 0x34u), *(__m128i *)&_mask_2045_1));
    }
    v5 = 2 * (_mask_mant9_1 & *(_QWORD *)&v1) + (_mask_mant_all8_1 & *(_QWORD *)&v1);
    v17 = v5;
    if ( COERCE_DOUBLE(COERCE_UNSIGNED_INT64(X - *(double *)&_real_one_4) & _real_notsign_2) < 0.0625 )
    {
      *(double *)v10.m128i_i64 = X - *(double *)&_real_one_4;
      v11 = *(double *)v10.m128i_i64 / (*(double *)v10.m128i_i64 + 2.0);
      v12 = *(double *)v10.m128i_i64 * v11;
      v13 = v11 + v11;
      v14 = *(double *)_mm_and_si128(v10, *(__m128i *)&_mask_lower).m128i_i64;
    ...
    v6 = v5 >> 44;
    *(_QWORD *)&v7 = _mm_or_si128(v4, *(__m128i *)&_real_half_3).m128i_u64[0];
    *(_QWORD *)&v8 = _mm_or_si128((__m128i)v17, *(__m128i *)&_real_half_3).m128i_u64[0];
    if ( X > 0.0 )
    {
    ...
    if ( X == 0.0 )
      return log10_special(X, -INFINITY, _flag_x_zero_1);
    return log10_special(X, NAN, _flag_x_neg_1);
  }
  if ( *(_QWORD *)&X != _real_inf_5 )
  {
    if ( *(_QWORD *)&X == *(_QWORD *)&_real_ninf_5 )
      return log10_special(X, NAN, _flag_x_neg_1);
    return log10_special(X, COERCE_LONG_DOUBLE(_real_qnanbit_3 | *(_QWORD *)&X), _flag_x_nan_5);
  }
  return X;
}
