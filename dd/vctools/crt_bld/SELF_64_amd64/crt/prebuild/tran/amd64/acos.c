...
LABEL_11:
  ...
  if ( v2 < 0 )
  {
    ...
    {
      if ( v1 )
        result = 3.141592653589793 - (v8 * v5 - 6.123233995736766e-17 + v7) * 2.0;
      else
        result = (v10
    ...
    {
      result = 1.570796326794897 - (x - (6.123233995736766e-17 - v8 * x));
    }
  }
  else
  {
    ...
    result = handle_error("acos", 13, 0xFFF8000000000000ui64, 1, 8, 33, x, 0.0, 1);
  }
  return result;
}
