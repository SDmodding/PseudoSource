...
// File Line: 139
// RVA: 0x12CF344
signed __int64 __fastcall ioinitCallback(_RTL_RUN_ONCE *initOnce, void *param, void **context)
{
  ioinfo *v4; // rax
  ...
  _STARTUPINFOW StartupInfo; // [rsp+50h] [rbp-88h]
  ...
  if ( StartupInfo.cbReserved2 && StartupInfo.lpReserved2 )
  {
    ...
    v26 = &StartupInfo.lpReserved2[*(_DWORD *)StartupInfo.lpReserved2 + 4];
    v8 = 2048;
    ...
    while ( v12 < v8 )
    {
      if ( (unsigned __int64)(*(_QWORD *)v7 + 2i64) > 1 && *v6 & 1 && (*v6 & 8 || GetFileType(*(HANDLE *)v7)) )
      {
        v13 = &_pioinfo[(signed __int64)v12 >> 5][v12 & 0x1F];
        v23 = (unsigned __int64)v13;
        v13->osfhnd = *(_QWORD *)v7;
        v13->osfile = *v6;
  ...
  while ( v14 < 3 )
  {
    ...
    if ( (unsigned __int64)(v15->osfhnd + 2) > 1 )
    {
      v15->osfile |= 0x80u;
      goto LABEL_44;
    }
    ...
    if ( !v14 )
      v16 = -10;
    v17 = (char *)GetStdHandle(v16);
    v18 = (__int64)v17;
    if ( (unsigned __int64)v17 < 0xFFFFFFFFFFFFFFFFui64 && v17 + 1 != (char *)1 )
    {
      v19 = GetFileType(v17);
      if ( v19 )
      {
...
__int64 ioinit()
{
  return (unsigned int)(InitOnceExecuteOnce(&_ioInitOnce, ioinitCallback, 0i64, 0i64) != 0) - 1;
}
