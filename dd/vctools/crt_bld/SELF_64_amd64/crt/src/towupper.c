// File Line: 38
// RVA: 0x12C1378
signed __int64 __fastcall towupper_l(unsigned __int16 c, localeinfo_struct *plocinfo)
{
  ...
  if ( c != -1 )
  {
    ...
    if ( v4 )
    {
      ...
      {
        v5 = (unsigned __int8)v3->pcumap[SrcStr];
      }
      else
      {
        v5 = SrcStr;
...
// File Line: 94
// RVA: 0x12C1448
signed __int64 __fastcall towupper(unsigned __int16 c)
{
