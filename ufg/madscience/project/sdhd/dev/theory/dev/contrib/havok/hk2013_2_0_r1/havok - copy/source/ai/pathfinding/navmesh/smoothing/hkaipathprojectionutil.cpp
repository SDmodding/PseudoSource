// File Line: 35
// RVA: 0xC08700
void __fastcall hkaiPathProjectionUtil::getSimplifiedPathPoints(hkArray<hkaiPath::PathPoint,hkContainerHeapAllocator> *pathIn, hkaiPath *pathOut, float _lengthTol, float _cosAngleTol, float _cosNormalAngleTol)
{
  int v5; // esi
  hkaiPath *v6; // rbp
  hkArray<hkaiPath::PathPoint,hkContainerHeapAllocator> *v7; // r14
  float v8; // xmm13_4
  float v9; // xmm14_4
  float v10; // xmm15_4
  __int64 v11; // rdi
  ...
  __m128 v13; // xmm5
  __m128 v14; // xmm10
  hkVector4f v15; // ST20_16
  __m128 v16; // xmm9
  __m128 v17; // xmm12
  __int64 v18; // r8
  hkaiPath::PathPoint *v19; // rdx
  __m128 v20; // xmm0
  __m128 v21; // xmm1
  __m128 v22; // xmm4
  __m128 v23; // xmm3
  ...
  v6 = pathOut;
  v7 = pathIn;
  LODWORD(v8) = (unsigned __int128)_mm_shuffle_ps((__m128)LODWORD(_lengthTol), (__m128)LODWORD(_lengthTol), 0);
  LODWORD(v9) = (unsigned __int128)_mm_shuffle_ps(
                                     (__m128)LODWORD(_cosNormalAngleTol),
                                     (__m128)LODWORD(_cosNormalAngleTol),
                                     0);
  LODWORD(v10) = (unsigned __int128)_mm_shuffle_ps((__m128)LODWORD(_cosAngleTol), (__m128)LODWORD(_cosAngleTol), 0);
  if ( pathIn->m_size > 0 )
  {
    v11 = 0i64;
    while ( 1 )
    {
      v12 = v6->m_points.m_size;
      v13 = v7->m_data[v11].m_normal.m_quad;
      v14 = v7->m_data[v11].m_position.m_quad;
      v15.m_quad = (__m128)v7->m_data[v11].m_position;
      v16 = v7->m_data[v11].m_normal.m_quad;
      v46 = *(_OWORD *)&v7->m_data[v11].m_userEdgeData;
      v17 = *(__m128 *)&v7->m_data[v11].m_userEdgeData;
      if ( (signed int)v12 <= 1 )
        goto LABEL_11;
      v18 = v6->m_points.m_size;
      v19 = v6->m_points.m_data;
      if ( DWORD1(v46) != *((_DWORD *)&v19[v18] - 3) )
        goto LABEL_11;
      if ( *((_BYTE *)&v19[v18] - 8) & 3 )
        goto LABEL_11;
      ...
      if ( (float)((float)(COERCE_FLOAT(_mm_shuffle_ps(v21, v21, 85)) + COERCE_FLOAT(_mm_shuffle_ps(v21, v21, 0)))
                 + COERCE_FLOAT(_mm_shuffle_ps(v21, v21, 170))) < (float)((float)((float)(COERCE_FLOAT(_mm_shuffle_ps(v22, v22, 85))
                                                                                        + COERCE_FLOAT(_mm_shuffle_ps(v22, v22, 0)))
                                                                                + COERCE_FLOAT(_mm_shuffle_ps(v22, v22, 170)))
                                                                        * v9) )
        goto LABEL_11;
      v23 = v19[v18 - 1].m_position.m_quad;
      v24 = _mm_mul_ps(v13, v23);
      v25 = _mm_add_ps(
              _mm_add_ps(_mm_shuffle_ps(v24, v24, 85), _mm_shuffle_ps(v24, v24, 0)),
              _mm_shuffle_ps(v24, v24, 170));
      v26 = _mm_mul_ps(v13, v14);
      v27 = _mm_sub_ps(v23, _mm_mul_ps(v25, v13));
      v28 = _mm_sub_ps(
              v14,
              _mm_mul_ps(
                _mm_add_ps(
                ...
                v13));
      v29 = _mm_sub_ps(v27, v28);
      v30 = _mm_mul_ps(v29, v29);
      if ( (float)((float)(COERCE_FLOAT(_mm_shuffle_ps(v30, v30, 85)) + COERCE_FLOAT(_mm_shuffle_ps(v30, v30, 0)))
                 + COERCE_FLOAT(_mm_shuffle_ps(v30, v30, 170))) < (float)(v8 * v8) )
        break;
      v35 = _mm_sub_ps(v28, v27);
      v36 = _mm_sub_ps(v27, v19[v12 - 2].m_position.m_quad);
      ...
      if ( (float)((float)(COERCE_FLOAT(_mm_shuffle_ps(v44, v44, 85)) + COERCE_FLOAT(_mm_shuffle_ps(v44, v44, 0)))
                 + COERCE_FLOAT(_mm_shuffle_ps(v44, v44, 170))) > v10 )
        goto LABEL_10;
LABEL_11:
      if ( v6->m_points.m_size == (v6->m_points.m_capacityAndFlags & 0x3FFFFFFF) )
        hkArrayUtil::_reserveMore((hkMemoryAllocator *)&hkContainerHeapAllocator::s_alloc.vfptr, &v6->m_points, 48);
      v45 = &v6->m_points.m_data[v6->m_points.m_size].m_position.m_quad;
      if ( v45 )
      {
        *v45 = v14;
        v45[1] = v16;
    ...
    v14 = _mm_add_ps(v14, _mm_mul_ps(_mm_sub_ps(v19[v18 - 1].m_position.m_quad, v14), (__m128)xmmword_141A711B0));
    v31 = _mm_add_ps(v13, _mm_mul_ps(_mm_sub_ps(*((__m128 *)&v19[v18] - 2), v13), (__m128)xmmword_141A711B0));
...
// File Line: 110
// RVA: 0xC08AF0
char __fastcall hkaiPathProjectionUtil::calcBarycentricCoordinates(hkVector4f *pos, hkVector4f *t0, hkVector4f *t1, hkVector4f *t2, hkVector4f *result)
{
  __m128 v5; // xmm10
  __m128 v6; // xmm11
  __m128 v7; // xmm1
  ...
  if ( v14.m128_f32[0] == 0.0
    || (float)(1.0 - (float)(v14.m128_f32[0] / v12.m128_f32[0])) >= COERCE_FLOAT(
                                                                      _mm_shuffle_ps(
...
// File Line: 159
// RVA: 0xC08EA0
__int64 __fastcall hkaiPathProjectionUtil::calcBarycentricHeightInterpolation(hkArrayBase<hkVector4f> *facePoints, hkVector4f *up, hkVector4f *pointInOut)
{
  hkArrayBase<hkVector4f> *v3; // r14
  hkVector4f *v4; // r15
  hkVector4f *v5; // r12
  _QWORD *v6; // r9
  _QWORD *v7; // rcx
  ...
  hkVector4f t2; // [rsp+30h] [rbp-B8h]
  hkVector4f t1; // [rsp+40h] [rbp-A8h]
  hkVector4f t0; // [rsp+50h] [rbp-98h]
  hkVector4f pos; // [rsp+60h] [rbp-88h]
  ...
  v11 = 1;
  v12 = 1i64;
  v13 = v3->m_data->m_quad;
  v14 = v3->m_size - 2;
  v15 = _mm_mul_ps(v5->m_quad, v4->m_quad);
  v16 = _mm_add_ps(_mm_add_ps(_mm_shuffle_ps(v15, v15, 85), _mm_shuffle_ps(v15, v15, 0)), _mm_shuffle_ps(v15, v15, 170));
  v17 = _mm_mul_ps(v5->m_quad, v13);
  v18 = _mm_sub_ps(v4->m_quad, _mm_mul_ps(v16, v5->m_quad));
  pos.m_quad = v18;
...
LABEL_8:
  ...
  else
  {
    ...
    {
      v23 = v5->m_quad;
      v24 = v3->m_data[v22].m_quad;
      v25 = v3->m_data[v22 + 1].m_quad;
      v26 = _mm_mul_ps(v5->m_quad, v24);
      v27 = _mm_add_ps(
              _mm_add_ps(_mm_shuffle_ps(v26, v26, 85), _mm_shuffle_ps(v26, v26, 0)),
              _mm_shuffle_ps(v26, v26, 170));
      v28 = _mm_mul_ps(v5->m_quad, v25);
      t0.m_quad = _mm_sub_ps(v24, _mm_mul_ps(v27, v5->m_quad));
      ...
      {
        if ( _mm_movemask_ps(_mm_and_ps(_mm_cmpleps(v20, v40.m_quad), _mm_cmpleps(v40.m_quad, v21))) == 15 )
          break;
      }
      ++v12;
      ++v11;
    ...
    v4->m_quad = _mm_add_ps(
                   _mm_add_ps(
                     _mm_mul_ps(_mm_shuffle_ps(v40.m_quad, v40.m_quad, 85), v3->m_data[v11 + 1].m_quad),
                     _mm_mul_ps(_mm_shuffle_ps(v40.m_quad, v40.m_quad, 0), v3->m_data[v11].m_quad)),
...
// File Line: 242
// RVA: 0xC08C90
_BOOL8 __fastcall hkaiPathProjectionUtil::calcBarycentricHeightInterpolation(hkaiGeneralAccessor *accessor, hkVector4f *up, unsigned int faceKey, hkVector4f *pointInOut)
{
  hkaiGeneralAccessor *v4; // rsi
  hkVector4f *v5; // rbp
  unsigned int v6; // ebx
  hkVector4f *v7; // r14
  _QWORD *v8; // rax
  ...
  unsigned __int64 v33; // rax
  signed __int64 v34; // rcx
  hkArrayBase<hkVector4f> faceVerticesOut; // [rsp+20h] [rbp-38h]
  ...
  v23 = v4->m_accessor;
  faceVerticesOut.m_data = v20;
  p = v20;
  faceVerticesOut.m_capacityAndFlags = v17 | 0x80000000;
  faceVerticesOut.m_size = v16->m_numEdges + 1;
  hkaiNavMeshUtils::getFaceVertices(v23, v16, &faceVerticesOut, v14);
  v24 = hkaiPathProjectionUtil::calcBarycentricHeightInterpolation(&faceVerticesOut, v7, v5);
  v25 = faceVerticesOut.m_size;
  v26 = (char *)p;
  v27 = v24;
  if ( p == faceVerticesOut.m_data )
    v25 = 0;
  faceVerticesOut.m_size = v25;
  v28 = (16 * v38 + 127) & 0xFFFFFF80;
...
// File Line: 257
// RVA: 0xC09170
__int64 __fastcall hkaiPathProjectionUtil::projectSegmentOntoFaceAndClipEdgesWorldUp(hkArrayBase<hkVector4f> *faceVerts, int faceIndex, hkVector4f *A, hkVector4f *B, hkVector4f *up, hkVector4f *Aout, hkVector4f *Bout)
{
  hkArrayBase<hkVector4f> *v7; // r14
  hkVector4f *v8; // rbx
  hkVector4f *v9; // rdi
  _QWORD *v10; // r10
  _QWORD *v11; // rcx
  ...
  hkVector4f planeOut; // [rsp+20h] [rbp-148h]
  __m128 v121; // [rsp+30h] [rbp-138h]
  __m128 v122; // [rsp+40h] [rbp-128h]
  __m128 v123; // [rsp+50h] [rbp-118h]
  hkVector4f pointInOut; // [rsp+60h] [rbp-108h]
  hkVector4f v125; // [rsp+70h] [rbp-F8h]
  hkVector4f edgePlaneOut; // [rsp+80h] [rbp-E8h]
  hkVector4f *v127; // [rsp+180h] [rbp+18h]
  hkVector4f *v128; // [rsp+188h] [rbp+20h]
  ...
  *Bout = (hkVector4f)v8->m_quad;
  v17 = up->m_quad;
  v18 = v7->m_size - 1;
  v19 = v18;
  v20 = _mm_mul_ps(up->m_quad, v8->m_quad);
  ...
  if ( v18 > 0 )
  {
    ...
    do
    {
      hkaiNavMeshUtils::calcEdgePlane(v7, v24, up, &edgePlaneOut);
      v28 = 0;
      ...
      {
LABEL_40:
        v37 = v7->m_data[v27].m_quad;
        v38 = v7->m_data[v27 + 1].m_quad;
        ...
        if ( v28 )
        {
          ...
          v55 = _mm_cmpltps(v54, query.m_quad);
          v56 = _mm_sub_ps(
                  v50,
                  _mm_mul_ps(
    ...
    if ( v14 != -1 )
    {
      v75 = v7->m_data[v14].m_quad;
      v76 = _mm_sub_ps(v7->m_data[v14 + 1].m_quad, v75);
  ...
  if ( (unsigned __int8)hkaiPathProjectionUtil::calcBarycentricHeightInterpolation(v7, up, &pointInOut) )
  {
...
LABEL_26:
  ...
  {
    v88 = 1;
    hkaiNavMeshUtils::calcFacePlane(v7, &planeOut);
  ...
  if ( v16 == -1 )
  {
    if ( (unsigned __int8)hkaiPathProjectionUtil::calcBarycentricHeightInterpolation(v7, up, &v125) )
    {
      v106 = v125.m_quad;
    }
    else
    {
      ...
      v109 = _mm_mul_ps(v128->m_quad, planeOut.m_quad);
  ...
  {
    v95 = v7->m_data[v16].m_quad;
    v96 = _mm_sub_ps(v7->m_data[v16 + 1].m_quad, v95);
