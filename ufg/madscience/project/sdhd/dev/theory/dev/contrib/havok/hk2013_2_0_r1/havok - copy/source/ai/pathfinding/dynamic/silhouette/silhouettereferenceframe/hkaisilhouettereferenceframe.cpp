// File Line: 14
// RVA: 0xC056C0
void __fastcall hkaiSilhouetteReferenceFrame::hkaiSilhouetteReferenceFrame(
        hkaiSilhouetteReferenceFrame *this,
        hkVector4f *up,
...
// File Line: 19
// RVA: 0xC056E0
void __fastcall hkaiSilhouetteReferenceFrame::set(
        hkaiSilhouetteReferenceFrame *this,
        hkVector4f *up,
        hkVector4f *referenceAxis)
{
  ...
  v5 = _mm_mul_ps(_mm_shuffle_ps(m_quad, m_quad, 201), referenceAxis->m_quad);
  this->m_referenceAxis = (hkVector4f)referenceAxis->m_quad;
  v6 = _mm_sub_ps(_mm_mul_ps(_mm_shuffle_ps(v4, v4, 201), m_quad), v5);
...
bool __fastcall hkaiSilhouetteReferenceFrame::isValid(hkaiSilhouetteReferenceFrame *this)
{
  ...
  if ( (_mm_movemask_ps(_mm_cmpunord_ps(v1.m_quad, v1.m_quad)) & 7) == 0 )
  {
    ...
    if ( COERCE_FLOAT((unsigned int)(2
                                   * COERCE_INT(
                                       (float)((float)(_mm_shuffle_ps(v2, v2, 85).m128_f32[0]
                                                     + _mm_shuffle_ps(v2, v2, 0).m128_f32[0])
                                     ...
                                     - 1.0)) >> 1) < _mm_shuffle_ps((__m128)0x38D1B717u, (__m128)0x38D1B717u, 0).m128_f32[0] )
    {
      ...
      if ( (_mm_movemask_ps(_mm_cmpunord_ps(v3.m_quad, v3.m_quad)) & 7) == 0 )
      {
        v4 = _mm_mul_ps(v3.m_quad, v3.m_quad);
        if ( COERCE_FLOAT((unsigned int)(2
                                       * COERCE_INT(
                                           (float)((float)(_mm_shuffle_ps(v4, v4, 85).m128_f32[0]
                                                         + _mm_shuffle_ps(v4, v4, 0).m128_f32[0])
                                                 + _mm_shuffle_ps(v4, v4, 170).m128_f32[0])
                                         - 1.0)) >> 1) < _mm_shuffle_ps((__m128)0x38D1B717u, (__m128)0x38D1B717u, 0).m128_f32[0] )
        {
          v5.m_quad = (__m128)this->m_orthogonalAxis;
          if ( (_mm_movemask_ps(_mm_cmpunord_ps(v5.m_quad, v5.m_quad)) & 7) == 0 )
          {
            v6 = _mm_mul_ps(v5.m_quad, v5.m_quad);
            if ( COERCE_FLOAT((unsigned int)(2
                                           * COERCE_INT(
                                               (float)((float)(_mm_shuffle_ps(v6, v6, 85).m128_f32[0]
...
// File Line: 37
// RVA: 0xC05770
hkSimdFloat32 *__fastcall hkaiSilhouetteReferenceFrame::getFirstComponent(
        hkaiSilhouetteReferenceFrame *this,
...
// File Line: 42
// RVA: 0xC057A0
hkSimdFloat32 *__fastcall hkaiSilhouetteReferenceFrame::getSecondComponent(
        hkaiSilhouetteReferenceFrame *this,
        hkSimdFloat32 *result,
        hkVector4f *v)
{
...
// File Line: 47
// RVA: 0xC057D0
void __fastcall hkaiSilhouetteReferenceFrame::setUnprojected(
        hkaiSilhouetteReferenceFrame *this,
        hkSimdFloat32 *first,
        hkSimdFloat32 *second,
        hkVector4f *vOut)
{
  __m128 v4; // xmm1

  *vOut = 0i64;
  v4 = _mm_add_ps(_mm_mul_ps(this->m_referenceAxis.m_quad, first->m_real), (__m128)0i64);
  *vOut = (hkVector4f)v4;
  vOut->m_quad = _mm_add_ps(_mm_mul_ps(this->m_orthogonalAxis.m_quad, second->m_real), v4);
}
