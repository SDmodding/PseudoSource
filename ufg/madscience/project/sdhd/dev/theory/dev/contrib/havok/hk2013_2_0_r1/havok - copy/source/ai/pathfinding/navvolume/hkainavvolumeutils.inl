// File Line: 58
// RVA: 0xC1DBD0
bool __fastcall hkaiNavVolumeUtils::getPortalPlaneIntersection(
        hkVector4f *p1,
        hkVector4f *p2,
        hkAabb *portal,
        hkSimdFloat32 *tOut)
{
  ...
  v7 = _mm_cmplt_ps(v6, v5);
  v8 = _mm_cmplt_ps(_mm_shuffle_ps(v4, v4, 170), _mm_or_ps(_mm_andnot_ps(v7, v5), _mm_and_ps(v6, v7)));
  v9 = _mm_or_ps(
  ...
  if ( COERCE_FLOAT((unsigned int)(2
                                 * COERCE_INT(
                                   ...
                                   + _mm_shuffle_ps(v12, v12, 170).m128_f32[0])) >> 1) < 0.00000011920929 )
    return 0;
