// File Line: 134
// RVA: 0x7FB260
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_filters::ColorMatrixFilter> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_filters::ColorMatrixFilter::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_filters::ColorMatrixFilter> *result, Scaleform::GFx::AS3::InstanceTraits::fl_filters::ColorMatrixFilter *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_filters::ColorMatrixFilter *v2; // rdi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_filters::ColorMatrixFilter> *v3; // rbx
  ...
  v8 = v4;
  if ( v4 )
    Scaleform::GFx::AS3::Instances::fl_filters::ColorMatrixFilter::ColorMatrixFilter(
      v4,
