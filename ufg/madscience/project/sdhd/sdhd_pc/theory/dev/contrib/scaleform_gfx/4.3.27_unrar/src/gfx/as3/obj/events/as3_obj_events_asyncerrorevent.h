// File Line: 127
// RVA: 0x7FAD50
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::AsyncErrorEvent> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_events::AsyncErrorEvent::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::AsyncErrorEvent> *result, Scaleform::GFx::AS3::InstanceTraits::fl_events::AsyncErrorEvent *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_events::AsyncErrorEvent *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::AsyncErrorEvent> *v3; // rdi
