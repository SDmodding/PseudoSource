// File Line: 145
// RVA: 0x7FB690
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::ErrorEvent> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_events::ErrorEvent::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::ErrorEvent> *result, Scaleform::GFx::AS3::InstanceTraits::fl_events::ErrorEvent *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_events::ErrorEvent *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::ErrorEvent> *v3; // rdi
