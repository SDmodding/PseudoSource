// File Line: 213
// RVA: 0x7FC800
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Loader> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_display::Loader::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Loader> *result, Scaleform::GFx::AS3::InstanceTraits::fl_display::Loader *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_display::Loader *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Loader> *v3; // rdi
