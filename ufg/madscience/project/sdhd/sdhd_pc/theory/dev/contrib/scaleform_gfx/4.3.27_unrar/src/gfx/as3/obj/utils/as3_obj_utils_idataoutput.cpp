// File Line: 89
// RVA: 0x878980
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_utils::IDataOutput::MakeClassTraits(
        ...
        Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::fl::Object::Object(v5, vm, &Scaleform::GFx::AS3::fl_utils::IDataOutputCI);
  ...
  if ( v8 )
  {
    Scaleform::GFx::AS3::InstanceTraits::Interface::Interface(v8, vm, &Scaleform::GFx::AS3::fl_utils::IDataOutputCI);
    v7.pV = v9;
  }
