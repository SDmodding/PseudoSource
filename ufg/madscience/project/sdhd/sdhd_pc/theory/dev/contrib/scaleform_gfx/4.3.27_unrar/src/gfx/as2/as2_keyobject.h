// File Line: 40
// RVA: 0x6F4670
signed __int64 __fastcall Scaleform::Render::DICommand_SetPixel32::GetType(SSInvokeClosureMethod *this)
{
  return 22i64;
}
...
// File Line: 75
// RVA: 0x7063A0
void __fastcall Scaleform::GFx::AS2::KeyCtorFunction::OnKeyUp(Scaleform::GFx::AS2::KeyCtorFunction *this, Scaleform::GFx::InteractiveObject *pmovie, Scaleform::GFx::EventId *evt, int __formal)
{
...
{
  Scaleform::GFx::AS2::KeyCtorFunction *v1; // rbx
