// File Line: 117
// RVA: 0x7FCE10
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_desktop::NativeDragOptions> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_desktop::NativeDragOptions::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_desktop::NativeDragOptions> *result, Scaleform::GFx::AS3::InstanceTraits::fl_desktop::NativeDragOptions *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_desktop::NativeDragOptions *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_desktop::NativeDragOptions> *v3; // rdi
  ...
  v3->pV = (Scaleform::GFx::AS3::Instances::fl_desktop::NativeDragOptions *)v5;
  return v3;
}
