// File Line: 62
// RVA: 0x87B250
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_security::IURIDereferencer::MakeClassTraits(Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *result, Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::fl::Object::Object(v5, v2, &Scaleform::GFx::AS3::fl_security::IURIDereferencerCI);
    v6->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::ClassTraits::fl_security::IURIDereferencer::`vftable;
  }
  else
  {
    v6 = 0i64;
  ...
  v8 = (Scaleform::GFx::AS3::InstanceTraits::Interface *)v4->vfptr->Alloc(v4, 240ui64, 0i64);
  if ( v8 )
  {
    Scaleform::GFx::AS3::InstanceTraits::Interface::Interface(
      v8,
      v2,
      &Scaleform::GFx::AS3::fl_security::IURIDereferencerCI);
    v7.pV = v9;
  }
