// File Line: 313
// RVA: 0x94EE20
Scaleform::Render::Matrix2x4<float> *__fastcall Scaleform::Render::operator*(
        ...
        Scaleform::Render::Matrix2x4<float> *this)
{
  float v1; // xmm1_4
  float v3; // xmm0_4
  Scaleform::Render::Matrix2x4<float> v5; // [rsp+20h] [rbp-28h] BYREF

  v1 = this->M[0][1];
  v5.M[0][0] = this->M[0][0];
  *(_QWORD *)&v5.M[0][1] = __PAIR64__(LODWORD(this->M[0][2]), LODWORD(v1));
  v3 = this->M[1][0];
  v5.M[0][3] = this->M[0][3];
  *(_QWORD *)&v5.M[1][0] = __PAIR64__(LODWORD(this->M[1][1]), LODWORD(v3));
  *(_QWORD *)&v5.M[1][2] = *(_QWORD *)&this->M[1][2];
  Scaleform::Render::Matrix2x4<float>::SetInverse(this, &v5);
  return this;
}
...
// File Line: 637
// RVA: 0x6DA810
Scaleform::Render::Matrix2x4<float> *__fastcall Scaleform::Render::Matrix2x4<float>::AppendScaling(
        Scaleform::Render::Matrix2x4<float> *this,
        float sx,
        float sy)
{
...
Scaleform::Render::Matrix2x4<float> *__fastcall Scaleform::Render::Matrix2x4<float>::AppendRotation(
        ...
        float radians)
{
  Scaleform::Render::Matrix2x4<float> m; // [rsp+20h] [rbp-48h] BYREF

  m.M[0][0] = cosf(radians);
  m.M[0][3] = 0.0;
  *(_OWORD *)&m.M[1][0] = __PAIR64__(LODWORD(m.M[0][0]), COERCE_UNSIGNED_INT(sinf(radians)));
  *(_QWORD *)&m.M[0][1] = (unsigned int)(LODWORD(m.M[1][0]) ^ _xmm[0]);
        ...
        Scaleform::Render::Matrix2x4<float> *m)
{
  ...
  v4 = this->M[1][0];
  v5 = this->M[1][1];
  this->M[0][0] = (float)(v3 * m->M[1][0]) + (float)(this->M[0][0] * m->M[0][0]);
  this->M[1][0] = (float)(v5 * m->M[1][0]) + (float)(v4 * m->M[0][0]);
...
// RVA: 0x7B0560
// attributes: thunk
Scaleform::Render::Matrix2x4<double> *__fastcall Scaleform::Render::Matrix2x4<double>::Append(
        Scaleform::Render::Matrix2x4<double> *this,
        Scaleform::Render::Matrix2x4<double> *m)
{
...
// File Line: 839
// RVA: 0x7B0AE0
Scaleform::Render::Matrix2x4<double> *__fastcall Scaleform::Render::Matrix2x4<double>::Append_NonOpt(
        Scaleform::Render::Matrix2x4<double> *this,
        Scaleform::Render::Matrix2x4<double> *m)
{
  double v2; // xmm3_8
  ...
  v6 = this->M[1][3];
  v7 = this->M[1][1];
  this->M[0][0] = v3 * m->M[0][1] + this->M[0][0] * m->M[0][0];
  this->M[1][0] = v3 * m->M[1][1] + v2 * m->M[1][0];
  this->M[0][1] = v7 * m->M[0][1] + v4 * m->M[0][0];
  v8 = v7 * m->M[1][1];
  v9 = v4 * m->M[1][0];
  this->M[0][2] = 0.0;
  this->M[1][2] = 0.0;
...
// File Line: 855
// RVA: 0x9B1010
void __fastcall Scaleform::Render::Matrix2x4<float>::SetLerp(
        Scaleform::Render::Matrix2x4<float> *this,
        Scaleform::Render::Matrix2x4<float> *m1,
        Scaleform::Render::Matrix2x4<float> *m2,
        float t)
...
// File Line: 870
// RVA: 0x7228D0
void __fastcall Scaleform::Render::Matrix2x4<float>::Transform(
        Scaleform::Render::Matrix2x4<float> *this,
        ...
        Scaleform::Render::Point<float> *p)
{
  ...
  *(_QWORD *)&m.M[0][0] = __PAIR64__(LODWORD(v8), LODWORD(v14.M[0][0]));
  *(_QWORD *)&v14.M[0][1] = __PAIR64__(LODWORD(v3), LODWORD(v8));
  v14.M[0][3] = v4;
  *(_QWORD *)&v14.M[1][0] = __PAIR64__(LODWORD(v9), LODWORD(v5));
  *(_QWORD *)&v14.M[1][2] = __PAIR64__(LODWORD(v11), LODWORD(v10));
  *(_QWORD *)&m.M[0][2] = __PAIR64__(LODWORD(v4), LODWORD(v3));
  *(_QWORD *)&m.M[1][0] = __PAIR64__(LODWORD(v9), LODWORD(v5));
  *(_QWORD *)&m.M[1][2] = __PAIR64__(LODWORD(v11), LODWORD(v10));
  Scaleform::Render::Matrix2x4<float>::SetInverse(&v14, &m);
  v12 = v14.M[1][1];
  v13 = v14.M[1][0];
  result->x = (float)((float)(v14.M[0][1] * p->y) + (float)(v14.M[0][0] * p->x)) + v14.M[0][3];
  result->y = (float)((float)(v12 * p->y) + (float)(v13 * p->x)) + v14.M[1][3];
}
...
float __fastcall Scaleform::Render::Matrix2x4<float>::GetMaxScale(Scaleform::Render::Matrix2x4<float> *this)
{
  ...
  if ( v2.m128_f32[0] >= v1.m128_f32[0] )
    ...
    LODWORD(result) = _mm_sqrt_ps(v1).m128_u32[0];
  return result;
}
...
// File Line: 988
// RVA: 0x98B250
double __fastcall Scaleform::Render::Matrix2x4<float>::GetRotation(Scaleform::Render::Matrix2x4<float> *this)
{
  double result; // xmm0_8

  *(_QWORD *)&result = LODWORD(this->M[1][0]);
  *(float *)&result = atan2f(*(float *)&result, this->M[0][0]);
  return result;
}
...
long double __fastcall Scaleform::Render::Matrix2x4<float>::GetXScaleDouble(Scaleform::Render::Matrix2x4<float> *this)
{
  ...
  *(_QWORD *)&result = *(_OWORD *)&_mm_sqrt_pd(v1);
  return result;
}
...
// File Line: 1006
// RVA: 0x6F53A0
long double __fastcall Scaleform::Render::Matrix2x4<float>::GetRotationDouble(
        Scaleform::Render::Matrix2x4<float> *this)
{
  return atan2(this->M[1][0], this->M[0][0]);
}
        ...
        float *dst)
{
  ...
  v15.m128_f32[3] = *dst;
  v10 = dst[1];
  v15.m128_f32[0] = dst[2] - *dst;
  v15.m128_f32[1] = dst[4] - *dst;
  v16.m128_f32[3] = v10;
  v16.m128_f32[0] = dst[3] - v10;
  v16.m128_f32[1] = dst[5] - v10;
  ...
  v13 = _mm_and_ps(v16, (__m128)`Scaleform::SIMD::SSE::InstructionSet::Constant<0,0,0,4294967295>::`2::v);
  v14 = _mm_mul_ps(_mm_shuffle_ps(v16, v16, 0), *(__m128 *)&this->M[0][0]);
  *(__m128 *)&this->M[0][0] = _mm_and_ps(
                                _mm_add_ps(
                                  _mm_add_ps(
                                    _mm_mul_ps(_mm_shuffle_ps(v15, v15, 85), *(__m128 *)&this->M[1][0]),
                                    _mm_mul_ps(_mm_shuffle_ps(v15, v15, 0), *(__m128 *)&this->M[0][0])),
                                  _mm_and_ps(
                                    v15,
  ...
  *(__m128 *)&this->M[1][0] = _mm_and_ps(
                                _mm_add_ps(
                                  _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(v16, v16, 85), *(__m128 *)&this->M[1][0]), v14),
                                  v13),
                                v12);
  return result;
}
