// File Line: 104
// RVA: 0x7FCA20
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::MorphShape> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_display::MorphShape::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::MorphShape> *result, Scaleform::GFx::AS3::InstanceTraits::fl_display::MorphShape *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_display::MorphShape *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::MorphShape> *v3; // rdi
