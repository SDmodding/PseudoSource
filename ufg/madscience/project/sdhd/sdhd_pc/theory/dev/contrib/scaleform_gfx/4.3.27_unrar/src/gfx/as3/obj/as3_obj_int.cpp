...
// File Line: 70
// RVA: 0x751130
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3toExponential(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
...
// File Line: 90
// RVA: 0x7A7620
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3toFixed(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
  Scaleform::GFx::AS3::Value *v6; // rsi
  Scaleform::GFx::AS3::Value *v7; // rbx
  Scaleform::GFx::AS3::VM *v8; // rdi
...
// File Line: 110
// RVA: 0x7A7B10
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3toPrecision(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
  Scaleform::GFx::AS3::Value *v6; // rsi
  Scaleform::GFx::AS3::Value *v7; // rbx
  Scaleform::GFx::AS3::VM *v8; // rdi
...
// File Line: 130
// RVA: 0x7A8500
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3toString(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc)
{
...
LABEL_3:
  ...
  Scaleform::LongFormatter::LongFormatter(&v18, v6->value.VS._1.VInt);
...
// File Line: 157
// RVA: 0x7A9270
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3valueOf(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result)
{
...
// File Line: 169
// RVA: 0x753A40
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::toStringProto(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
  ...
  if ( (_this->Flags & 0x1F) - 12 > 3 )
    goto LABEL_9;
  v10 = vm->TraitsInt.pObject->ITraits.pObject;
...
LABEL_9:
    Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3toString(v9, v8, v7, v6, argc, argv);
  else
...
// File Line: 179
// RVA: 0x753DE0
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::toLocaleStringProto(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
...
// File Line: 185
// RVA: 0x754880
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::valueOfProto(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result)
{
  ...
  if ( (_this->Flags & 0x1F) - 12 <= 3 )
  {
    ...
    v8 = vm->TraitsInt.pObject->ITraits.pObject;
    ...
    if ( *(Scaleform::GFx::AS3::Object **)&v7 == Scaleform::GFx::AS3::Class::GetPrototype(v8->pConstructor.pObject) )
    {
      v9 = 0;
LABEL_10:
      Scaleform::GFx::AS3::Value::SetSInt32(v4, v9);
      return;
    }
  }
  if ( (v5->Flags & 0x1F) - 2 <= 1 )
  {
    v9 = v5->value.VS._1.VInt;
    goto LABEL_10;
  }
...
// File Line: 195
// RVA: 0x755400
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::toExponentialProto(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
  Scaleform::GFx::AS3::Value *v6; // rdi
  Scaleform::GFx::AS3::VM *v7; // rbx
  ...
  if ( Scaleform::GFx::AS3::Value::Convert2Int32(_this, (Scaleform::GFx::AS3::CheckResult *)&v16, (int *)&v12)->Result )
  {
    _thisa.Flags = 2;
    v14.ID = v12;
    _thisa.value = (Scaleform::GFx::AS3::Value::VU)v14;
    Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3toExponential(v8, v7, &_thisa, v6, argc, argv);
  }
  else
  {
...
// File Line: 211
// RVA: 0x755AE0
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::toFixedProto(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
  Scaleform::GFx::AS3::Value *v6; // rdi
  Scaleform::GFx::AS3::VM *v7; // rbx
  Scaleform::GFx::AS3::ThunkInfo *v8; // rsi
  ...
  if ( Scaleform::GFx::AS3::Value::Convert2Int32(_this, (Scaleform::GFx::AS3::CheckResult *)&v16, (int *)&v12)->Result )
  {
    ...
    v14.ID = v12;
    _thisa.value = (Scaleform::GFx::AS3::Value::VU)v14;
    Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3toFixed(v8, v7, &_thisa, v6, argc, argv);
  }
  else
  {
    Scaleform::GFx::AS3::VM::Error::Error(&v14, eCheckTypeFailedError, v7);
...
// File Line: 227
// RVA: 0x7562E0
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl::int_::toPrecisionProto(Scaleform::GFx::AS3::ThunkInfo *ti, Scaleform::GFx::AS3::VM *vm, Scaleform::GFx::AS3::Value *_this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
  Scaleform::GFx::AS3::Value *v6; // rdi
  Scaleform::GFx::AS3::VM *v7; // rbx
  Scaleform::GFx::AS3::ThunkInfo *v8; // rsi
  ...
  if ( Scaleform::GFx::AS3::Value::Convert2Int32(_this, (Scaleform::GFx::AS3::CheckResult *)&v16, (int *)&v12)->Result )
  {
    ...
    v14.ID = v12;
    _thisa.value = (Scaleform::GFx::AS3::Value::VU)v14;
    Scaleform::GFx::AS3::InstanceTraits::fl::int_::AS3toPrecision(v8, v7, &_thisa, v6, argc, argv);
  }
  else
  {
    Scaleform::GFx::AS3::VM::Error::Error(&v14, eCheckTypeFailedError, v7);
...
// File Line: 283
// RVA: 0x7F4F10
void __fastcall Scaleform::GFx::AS3::Classes::fl::int_::InitPrototype(Scaleform::GFx::AS3::Classes::fl::int_ *this, Scaleform::GFx::AS3::Object *obj)
{
...
// File Line: 299
// RVA: 0x7B95A0
void __fastcall Scaleform::GFx::AS3::Classes::fl::int_::Construct(Scaleform::GFx::AS3::Classes::fl::int_ *this, Scaleform::GFx::AS3::Value *result, unsigned int argc, Scaleform::GFx::AS3::Value *argv)
{
  Scaleform::GFx::AS3::Value *v4; // rbx
  int v; // [rsp+20h] [rbp-18h]
...
// File Line: 332
// RVA: 0x7585A0
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl::int_::MakeClassTraits(Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *result, Scaleform::GFx::AS3::VM *vm)
{
...
// File Line: 346
// RVA: 0x7B6B20
char __fastcall Scaleform::GFx::AS3::ClassTraits::fl::int_::Coerce(Scaleform::GFx::AS3::ClassTraits::fl::int_ *this, Scaleform::GFx::AS3::Value *value, Scaleform::GFx::AS3::Value *result)
{
  ...
  if ( !Scaleform::GFx::AS3::Value::Convert2Int32(value, &resulta, &v)->Result )
    return 0;
  Scaleform::GFx::AS3::Value::SetSInt32(v3, v);
  return 1;
}
