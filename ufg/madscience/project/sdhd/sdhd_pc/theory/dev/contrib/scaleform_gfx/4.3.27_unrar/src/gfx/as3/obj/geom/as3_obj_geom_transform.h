// File Line: 192
// RVA: 0x7FDCE0
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_geom::Transform> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_geom::Transform::MakeInstance(
        Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_geom::Transform> *result,
