// File Line: 116
// RVA: 0x7FCB80
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::MouseEventEx> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_gfx::MouseEventEx::MakeInstance(
        Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::MouseEventEx> *result,
        Scaleform::GFx::AS3::InstanceTraits::fl_gfx::MouseEventEx *t)
{
  ...
  result->pV = (Scaleform::GFx::AS3::Instances::fl_gfx::MouseEventEx *)v5;
  return result;
}
