// File Line: 171
// RVA: 0x7FB1E0
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_desktop::Clipboard> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_desktop::Clipboard::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_desktop::Clipboard> *result, Scaleform::GFx::AS3::InstanceTraits::fl_desktop::Clipboard *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_desktop::Clipboard *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_desktop::Clipboard> *v3; // rdi
