// File Line: 39
// RVA: 0x77D080
void __fastcall Scaleform::GFx::AS3::Instances::fl_events::FileListEvent::FileListEvent(Scaleform::GFx::AS3::Instances::fl_events::FileListEvent *this, Scaleform::GFx::AS3::InstanceTraits::Traits *t)
{
  Scaleform::GFx::AS3::Instances::fl_events::FileListEvent *v2; // rbx
  ...
  v2->Phase = 2;
  *((_BYTE *)&v2->0 + 84) &= 0xC0u;
  v2->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::Instances::fl_events::FileListEvent::`vftable';
  v2->files.pObject = 0i64;
}

// File Line: 66
// RVA: 0x7FF580
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl_events::FileListEvent::MakeObject(Scaleform::GFx::AS3::InstanceTraits::fl_events::FileListEvent *this, Scaleform::GFx::AS3::Value *result, Scaleform::GFx::AS3::InstanceTraits::Traits *t)
{
  Scaleform::GFx::AS3::Value *v3; // rbx
  Scaleform::GFx::AS3::Object **v4; // rax
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::FileListEvent> resulta; // [rsp+48h] [rbp+20h]

  v3 = result;
  v4 = (Scaleform::GFx::AS3::Object **)Scaleform::GFx::AS3::InstanceTraits::fl_events::FileListEvent::MakeInstance(
                                         &resulta,
...
// File Line: 108
// RVA: 0x764ED0
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_events::FileListEvent::MakeClassTraits(Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *result, Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::Traits::Traits(v5, v2, &Scaleform::GFx::AS3::fl_events::FileListEventCI);
  ...
  if ( v7 )
  {
    Scaleform::GFx::AS3::InstanceTraits::CTraits::CTraits(v7, v2, &Scaleform::GFx::AS3::fl_events::FileListEventCI);
