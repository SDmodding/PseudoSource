// File Line: 168
// RVA: 0x7FD210
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_events::ProgressEvent::MakeInstance(
        Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent> *result,
        Scaleform::GFx::AS3::InstanceTraits::fl_events::ProgressEvent *t)
{
  ...
  v8 = v4;
  if ( v4 )
    Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent::ProgressEvent(v4, t);
  result->pV = v4;
  return result;
}
