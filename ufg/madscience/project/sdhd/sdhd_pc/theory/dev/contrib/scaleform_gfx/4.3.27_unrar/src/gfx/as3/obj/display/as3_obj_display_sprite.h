// File Line: 236
// RVA: 0x7FD900
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Sprite> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_display::Sprite::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Sprite> *result, Scaleform::GFx::AS3::InstanceTraits::fl_display::Sprite *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_display::Sprite *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Sprite> *v3; // rdi
  ...
  v5 = (Scaleform::GFx::AS3::Instances::fl_display::Sprite *)v4;
  v8 = v4;
  v9 = v4;
  if ( v4 )
  {
