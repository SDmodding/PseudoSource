// File Line: 147
// RVA: 0x7FD480
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Scene> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_display::Scene::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Scene> *result, Scaleform::GFx::AS3::InstanceTraits::fl_display::Scene *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_display::Scene *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Scene> *v3; // rdi
