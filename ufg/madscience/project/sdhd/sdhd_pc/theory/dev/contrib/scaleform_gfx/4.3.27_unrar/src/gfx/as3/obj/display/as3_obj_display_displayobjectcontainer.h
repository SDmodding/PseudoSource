// File Line: 253
// RVA: 0x7FB4B0
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::DisplayObjectContainer> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_display::DisplayObjectContainer::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::DisplayObjectContainer> *result, Scaleform::GFx::AS3::InstanceTraits::fl_display::DisplayObjectContainer *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_display::DisplayObjectContainer *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::DisplayObjectContainer> *v3; // rdi
