// File Line: 62
// RVA: 0x877D90
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_utils::IExternalizable::MakeClassTraits(Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *result, Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::fl::Object::Object(v5, v2, &Scaleform::GFx::AS3::fl_utils::IExternalizableCI);
  ...
  if ( v8 )
  {
    Scaleform::GFx::AS3::InstanceTraits::Interface::Interface(v8, v2, &Scaleform::GFx::AS3::fl_utils::IExternalizableCI);
    v7.pV = v9;
  }
