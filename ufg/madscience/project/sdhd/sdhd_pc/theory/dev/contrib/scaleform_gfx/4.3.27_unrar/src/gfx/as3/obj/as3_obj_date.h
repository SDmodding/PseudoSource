// File Line: 784
// RVA: 0x7FB340
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl::Date> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl::Date::MakeInstance(
        Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl::Date> *result,
        Scaleform::GFx::AS3::InstanceTraits::fl::Date *t)
{
  ...
  result->pV = (Scaleform::GFx::AS3::Instances::fl::Date *)v5;
  return result;
}
