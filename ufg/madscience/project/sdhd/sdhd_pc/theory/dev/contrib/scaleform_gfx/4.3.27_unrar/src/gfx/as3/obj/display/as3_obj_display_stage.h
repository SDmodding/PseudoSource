// File Line: 497
// RVA: 0x7FD9A0
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Stage> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_display::Stage::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Stage> *result, Scaleform::GFx::AS3::InstanceTraits::fl_display::Stage *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_display::Stage *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::Stage> *v3; // rdi
