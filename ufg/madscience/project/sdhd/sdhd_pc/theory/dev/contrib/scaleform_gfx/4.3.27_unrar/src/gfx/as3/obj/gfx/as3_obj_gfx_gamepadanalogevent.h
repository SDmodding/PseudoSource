// File Line: 199
// RVA: 0x7FBB80
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::GamePadAnalogEvent> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_gfx::GamePadAnalogEvent::MakeInstance(
        Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::GamePadAnalogEvent> *result,
        Scaleform::GFx::AS3::InstanceTraits::fl_gfx::GamePadAnalogEvent *t)
{
  ...
  v8 = v4;
  if ( v4 )
    Scaleform::GFx::AS3::Instances::fl_gfx::GamePadAnalogEvent::GamePadAnalogEvent(v4, t);
  result->pV = v4;
  return result;
}
