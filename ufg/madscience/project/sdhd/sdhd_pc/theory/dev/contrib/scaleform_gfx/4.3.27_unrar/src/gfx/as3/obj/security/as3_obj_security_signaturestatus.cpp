// File Line: 66
// RVA: 0x86CA50
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_security::SignatureStatus::MakeClassTraits(
        ...
        Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::fl::Object::Object(v5, vm, &Scaleform::GFx::AS3::fl_security::SignatureStatusCI);
  ...
  if ( v10 )
  {
    ...
    v11[1].pRCCRaw = (unsigned __int64)&customCaption;
