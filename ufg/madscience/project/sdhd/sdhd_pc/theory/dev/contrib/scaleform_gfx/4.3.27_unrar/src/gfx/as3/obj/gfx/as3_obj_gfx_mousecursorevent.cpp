// File Line: 39
// RVA: 0x77FAA0
void __fastcall Scaleform::GFx::AS3::Instances::fl_gfx::MouseCursorEvent::MouseCursorEvent(
        Scaleform::GFx::AS3::Instances::fl_gfx::MouseCursorEvent *this,
        Scaleform::GFx::AS3::InstanceTraits::Traits *t)
{
  ...
  *((_BYTE *)&this->Scaleform::GFx::AS3::Instances::fl_events::Event + 84) &= 0xC0u;
  this->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::Instances::fl_gfx::MouseCursorEvent::`vftable;
  Scaleform::GFx::AS3::DefaultValue<Scaleform::GFx::ASString const &>(
    &this->cursor,
    this->pTraits.pObject->pVM->StringManagerRef);
  this->mouseIdx = 0;
  *((_BYTE *)&this->Scaleform::GFx::AS3::Instances::fl_events::Event + 84) &= ~1u;
  *((_BYTE *)&this->Scaleform::GFx::AS3::Instances::fl_events::Event + 84) |= 2u;
}

// File Line: 69
// RVA: 0x7FFBE0
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl_gfx::MouseCursorEvent::MakeObject(
...
{
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::MouseCursorEvent> *Instance; // rax
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::MouseCursorEvent> resulta; // [rsp+48h] [rbp+20h] BYREF

  Instance = Scaleform::GFx::AS3::InstanceTraits::fl_gfx::MouseCursorEvent::MakeInstance(&resulta, t);
  Scaleform::GFx::AS3::Value::Pick(result, Instance->pV);
}

// File Line: 109
// RVA: 0x742970
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_gfx::MouseCursorEvent::MakeClassTraits(
        ...
        Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::Traits::Traits(v5, vm, &Scaleform::GFx::AS3::fl_gfx::MouseCursorEventCI);
  ...
  if ( v7 )
  {
    Scaleform::GFx::AS3::InstanceTraits::CTraits::CTraits(v7, vm, &Scaleform::GFx::AS3::fl_gfx::MouseCursorEventCI);
