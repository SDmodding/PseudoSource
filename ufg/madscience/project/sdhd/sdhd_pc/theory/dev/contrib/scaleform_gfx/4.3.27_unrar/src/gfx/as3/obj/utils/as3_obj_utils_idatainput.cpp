// File Line: 95
// RVA: 0x877760
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_utils::IDataInput::MakeClassTraits(Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *result, Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::fl::Object::Object(v5, v2, &Scaleform::GFx::AS3::fl_utils::IDataInputCI);
    v6->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::ClassTraits::fl_utils::IDataInput::`vftable;
  }
  else
  {
    v6 = 0i64;
  ...
  if ( v8 )
  {
    Scaleform::GFx::AS3::InstanceTraits::Interface::Interface(v8, v2, &Scaleform::GFx::AS3::fl_utils::IDataInputCI);
    v7.pV = v9;
  }
