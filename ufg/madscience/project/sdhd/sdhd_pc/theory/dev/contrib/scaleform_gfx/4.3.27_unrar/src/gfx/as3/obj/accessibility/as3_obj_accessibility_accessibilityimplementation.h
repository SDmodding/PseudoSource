// File Line: 134
// RVA: 0x7FAB00
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_accessibility::AccessibilityImplementation> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_accessibility::AccessibilityImplementation::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_accessibility::AccessibilityImplementation> *result, Scaleform::GFx::AS3::InstanceTraits::fl_accessibility::AccessibilityImplementation *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_accessibility::AccessibilityImplementation *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_accessibility::AccessibilityImplementation> *v3; // rdi
