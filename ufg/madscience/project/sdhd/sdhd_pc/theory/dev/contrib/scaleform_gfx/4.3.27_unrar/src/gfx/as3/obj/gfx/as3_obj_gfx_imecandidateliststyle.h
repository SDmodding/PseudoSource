// File Line: 129
// RVA: 0x7FC3D0
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::IMECandidateListStyle> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_gfx::IMECandidateListStyle::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::IMECandidateListStyle> *result, Scaleform::GFx::AS3::InstanceTraits::fl_gfx::IMECandidateListStyle *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_gfx::IMECandidateListStyle *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_gfx::IMECandidateListStyle> *v3; // rdi
  Scaleform::GFx::AS3::Instance *v4; // rax
  Scaleform::GFx::AS3::Instances::fl_gfx::IMECandidateListStyle *v5; // rbx
  ...
  v5 = (Scaleform::GFx::AS3::Instances::fl_gfx::IMECandidateListStyle *)v4;
  v8 = v4;
  v9 = v4;
  if ( v4 )
  {
    ...
    *(_QWORD *)&v5->selectedIndexBackgroundColor = -1i64;
    *(_QWORD *)&v5->readingWindowBackgroundColor = -1i64;
  }
  else
  {
    v5 = 0i64;
