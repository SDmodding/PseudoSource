// File Line: 125
// RVA: 0x7FAF80
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_filters::BitmapFilter> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_filters::BitmapFilter::MakeInstance(
        Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_filters::BitmapFilter> *result,
