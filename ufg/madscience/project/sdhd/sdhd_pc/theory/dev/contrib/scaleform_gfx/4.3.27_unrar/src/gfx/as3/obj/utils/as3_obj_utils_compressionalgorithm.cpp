// File Line: 64
// RVA: 0x874C00
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_utils::CompressionAlgorithm::MakeClassTraits(Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *result, Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::fl::Object::Object(v5, v2, &Scaleform::GFx::AS3::fl_utils::CompressionAlgorithmCI);
    v6->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::ClassTraits::fl_utils::CompressionAlgorithm::`vftable;
  }
  else
  {
    v6 = 0i64;
  ...
  if ( v8 )
  {
    Scaleform::GFx::AS3::InstanceTraits::fl::Object::Object(
      v8,
      v2,
      &Scaleform::GFx::AS3::fl_utils::CompressionAlgorithmCI);
    v7.pV = v9;
  }
  ...
  if ( v10 )
  {
    ...
    v11->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::Classes::fl_utils::CompressionAlgorithm::`vftable;
    v11[1].vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)"deflate";
    v11[1].pRCCRaw = (unsigned __int64)"zlib";
  }
  return v3;
}
