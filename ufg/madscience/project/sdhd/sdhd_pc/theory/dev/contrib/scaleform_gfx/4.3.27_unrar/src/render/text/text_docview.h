...
// File Line: 240
// RVA: 0x8C7FF0
__int64 __fastcall Scaleform::Render::Text::DocView::DocumentListener::Editor_OnCharacter(Scaleform::Render::Text::DocView::DocumentListener *this, Scaleform::Render::Text::EditorKitBase *__formal, wchar_t srcChar)
{
  return srcChar;
}
...
// File Line: 248
// RVA: 0x8D6230
Scaleform::String *__fastcall Scaleform::GFx::ResourceReport::GetResourceName(Scaleform::GFx::ResourceReport *this, Scaleform::String *result)
{
...
void __fastcall Scaleform::Render::Text::DocView::SetDefaultShadow(Scaleform::Render::Text::DocView *this)
{
  ...
  *(_QWORD *)&this->Filter.ShadowParams.BlurX = 0i64;
  ...
  v2 = cosf(0.78539819);
  v3 = sinf(0.78539819);
  v1->Filter.ShadowParams.Offset.x = v2 * 4.0;
  v1->Filter.ShadowParams.Offset.y = v3 * 4.0;
}
