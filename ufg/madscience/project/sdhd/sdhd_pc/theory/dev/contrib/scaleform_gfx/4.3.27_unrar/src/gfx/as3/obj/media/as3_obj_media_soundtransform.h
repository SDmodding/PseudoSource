// File Line: 207
// RVA: 0x7FD880
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_media::SoundTransform> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_media::SoundTransform::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_media::SoundTransform> *result, Scaleform::GFx::AS3::InstanceTraits::fl_media::SoundTransform *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_media::SoundTransform *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_media::SoundTransform> *v3; // rdi
