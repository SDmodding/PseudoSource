// File Line: 191
// RVA: 0x7FD0E0
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_geom::Point> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_geom::Point::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_geom::Point> *result, Scaleform::GFx::AS3::InstanceTraits::fl_geom::Point *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_geom::Point *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_geom::Point> *v3; // rdi
  Scaleform::GFx::AS3::Instance *v4; // rax
  Scaleform::GFx::AS3::Instances::fl_geom::Point *v5; // rbx
  ...
  v5 = (Scaleform::GFx::AS3::Instances::fl_geom::Point *)v4;
  v8 = v4;
  v9 = v4;
  if ( v4 )
  {
