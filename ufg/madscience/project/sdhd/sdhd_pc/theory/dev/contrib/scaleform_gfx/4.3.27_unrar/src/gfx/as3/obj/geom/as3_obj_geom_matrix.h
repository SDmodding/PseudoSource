// File Line: 215
// RVA: 0x7FC980
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_geom::Matrix> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_geom::Matrix::MakeInstance(Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_geom::Matrix> *result, Scaleform::GFx::AS3::InstanceTraits::fl_geom::Matrix *t)
{
  Scaleform::GFx::AS3::InstanceTraits::fl_geom::Matrix *v2; // rsi
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_geom::Matrix> *v3; // rdi
  Scaleform::GFx::AS3::Instance *v4; // rax
  Scaleform::GFx::AS3::Instances::fl_geom::Matrix *v5; // rbx
  ...
  v5 = (Scaleform::GFx::AS3::Instances::fl_geom::Matrix *)v4;
  v8 = v4;
  v9 = v4;
  if ( v4 )
  {
