// File Line: 118
// RVA: 0x7FBF40
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::GraphicsBitmapFill> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_display::GraphicsBitmapFill::MakeInstance(
        Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_display::GraphicsBitmapFill> *result,
        Scaleform::GFx::AS3::InstanceTraits::fl_display::GraphicsBitmapFill *t)
{
  ...
  result->pV = (Scaleform::GFx::AS3::Instances::fl_display::GraphicsBitmapFill *)v5;
  return result;
}
