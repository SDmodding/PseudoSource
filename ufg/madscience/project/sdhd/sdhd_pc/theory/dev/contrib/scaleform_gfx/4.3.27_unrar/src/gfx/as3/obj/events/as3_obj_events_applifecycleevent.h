// File Line: 144
// RVA: 0x7FAC00
Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::AppLifecycleEvent> *__fastcall Scaleform::GFx::AS3::InstanceTraits::fl_events::AppLifecycleEvent::MakeInstance(
        Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::AppLifecycleEvent> *result,
        Scaleform::GFx::AS3::InstanceTraits::fl_events::AppLifecycleEvent *t)
{
  ...
  v8 = v4;
  if ( v4 )
    Scaleform::GFx::AS3::Instances::fl_events::AppLifecycleEvent::AppLifecycleEvent(v4, t);
  result->pV = v4;
  return result;
}
