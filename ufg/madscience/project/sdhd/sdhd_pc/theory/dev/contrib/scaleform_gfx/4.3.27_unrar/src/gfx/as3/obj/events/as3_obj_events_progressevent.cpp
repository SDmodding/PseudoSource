...
// File Line: 51
// RVA: 0x7815D0
void __fastcall Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent::ProgressEvent(
        ...
        Scaleform::GFx::AS3::InstanceTraits::Traits *t)
{
  ...
  *((_BYTE *)&this->Scaleform::GFx::AS3::Instances::fl_events::Event + 84) &= 0xC0u;
  this->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent::`vftable;
  this->BytesTotal = 0i64;
  this->BytesLoaded = 0i64;
}

// File Line: 58
// RVA: 0x82E4F0
void __fastcall Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent::bytesLoadedGet(
        Scaleform::GFx::AS3::Instances::fl_events::OutputProgressEvent *this,
        long double *result)
{
  signed __int64 BytesPending; // rax
  double v3; // xmm0_8

  BytesPending = this->BytesPending;
  v3 = (double)(int)BytesPending;
  if ( BytesPending < 0 )
...
// File Line: 65
// RVA: 0x82E540
void __fastcall Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent::bytesLoadedSet(
        Scaleform::GFx::AS3::Instances::fl_events::OutputProgressEvent *this,
        ...
        long double value)
{
  ...
  this->BytesPending = v3 + (unsigned int)(int)value;
}

// File Line: 93
// RVA: 0x866B60
void __fastcall Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent::toString(
        Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent *this,
...
// File Line: 120
// RVA: 0x7E9600
Scaleform::GFx::AS3::Value *__fastcall Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent::GetEventClass(
        Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent *this)
{
...
// File Line: 167
// RVA: 0x7FFE50
void __fastcall Scaleform::GFx::AS3::InstanceTraits::fl_events::ProgressEvent::MakeObject(
        Scaleform::GFx::AS3::InstanceTraits::fl_events::ProgressEvent *this,
        Scaleform::GFx::AS3::Value *result,
        Scaleform::GFx::AS3::InstanceTraits::fl_events::ProgressEvent *t)
{
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent> *Instance; // rax
  Scaleform::Pickable<Scaleform::GFx::AS3::Instances::fl_events::ProgressEvent> resulta; // [rsp+48h] [rbp+20h] BYREF

  Instance = Scaleform::GFx::AS3::InstanceTraits::fl_events::ProgressEvent::MakeInstance(&resulta, t);
  Scaleform::GFx::AS3::Value::Pick(result, Instance->pV);
}

// File Line: 209
// RVA: 0x73B380
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_events::ProgressEvent::MakeClassTraits(
        ...
        Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::Traits::Traits(v5, vm, &Scaleform::GFx::AS3::fl_events::ProgressEventCI);
  ...
  if ( v7 )
  {
    Scaleform::GFx::AS3::InstanceTraits::CTraits::CTraits(v7, vm, &Scaleform::GFx::AS3::fl_events::ProgressEventCI);
