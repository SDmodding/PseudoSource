// File Line: 64
// RVA: 0x870810
Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *__fastcall Scaleform::GFx::AS3::ClassTraits::fl_text::TextFieldType::MakeClassTraits(Scaleform::Pickable<Scaleform::GFx::AS3::ClassTraits::Traits> *result, Scaleform::GFx::AS3::VM *vm)
{
  ...
  if ( v5 )
  {
    Scaleform::GFx::AS3::ClassTraits::fl::Object::Object(v5, v2, &Scaleform::GFx::AS3::fl_text::TextFieldTypeCI);
    v6->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::ClassTraits::fl_text::TextFieldType::`vftable;
  }
  else
  {
    v6 = 0i64;
  ...
  if ( v8 )
  {
    Scaleform::GFx::AS3::InstanceTraits::fl::Object::Object(v8, v2, &Scaleform::GFx::AS3::fl_text::TextFieldTypeCI);
    v7.pV = v9;
  }
  ...
  if ( v10 )
  {
    ...
    v11->vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)&Scaleform::GFx::AS3::Classes::fl_text::TextFieldType::`vftable;
    v11[1].vfptr = (Scaleform::GFx::AS3::RefCountBaseGC<328>Vtbl *)"dynamic";
    v11[1].pRCCRaw = (unsigned __int64)"input";
  }
  return v3;
}
