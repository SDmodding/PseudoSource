...
// File Line: 277
// RVA: 0x9896D0
__int64 __fastcall Scaleform::Render::Tessellator::GetMeshVertexCount(Scaleform::Render::Tessellator *this, unsigned int meshIdx)
{
...
// File Line: 278
// RVA: 0x989620
__int64 __fastcall Scaleform::Render::Tessellator::GetMeshTriangleCount(Scaleform::Render::Tessellator *this, unsigned int meshIdx)
{
...
{
  Scaleform::Render::ArrayPaged<Scaleform::Render::Tessellator::SrcVertexType,4,16> *v3; // rbx
  ...
  if ( v4 >= this->SrcVertices.NumPages )
    Scaleform::Render::ArrayPaged<Scaleform::Render::VertexBasic,4,16>::allocPage(
      ...
      v4);
  v3->Pages[v4][v3->Size & 0xF] = (Scaleform::Render::Tessellator::SrcVertexType)__PAIR__(LODWORD(y), LODWORD(x));
  ++v3->Size;
}
