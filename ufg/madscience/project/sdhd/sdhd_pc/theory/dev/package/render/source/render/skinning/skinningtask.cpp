...
__int64 Render::_dynamic_initializer_for__gTaskFunctionDecl_SkinBufferTask__()
{
  ...
  return atexit(Render::_dynamic_atexit_destructor_for__gTaskFunctionDecl_SkinBufferTask__);
}
...
__int64 Render::_dynamic_initializer_for__gTaskFunctionDecl_SkinMorphBufferTask__()
{
  ...
  return atexit(Render::_dynamic_atexit_destructor_for__gTaskFunctionDecl_SkinMorphBufferTask__);
}
...
__int64 Render::_dynamic_initializer_for__gTaskFunctionDecl_SkinCacheBufferTask__()
{
  ...
  return atexit(Render::_dynamic_atexit_destructor_for__gTaskFunctionDecl_SkinCacheBufferTask__);
}

// File Line: 13
// RVA: 0x1EC90
void __fastcall Render::SkinBufferTask(int worker_id, UFG::qMemoryStreamer *memory_streamer, void *param0, void *param1)
{
  __int64 v4; // rdi
  __m128 *v5; // rbp
  __m128 v6; // xmm6
  ...
  __m128i v99; // xmm2
  __m128i v100; // xmm2
  __m128i v101; // [rsp+10h] [rbp-4158h]
  ...
  __int128 v112; // [rsp+C0h] [rbp-40A8h]
  __int128 v113; // [rsp+D0h] [rbp-4098h]
  __int128 v114; // [rsp+E0h] [rbp-4088h]
  __int128 v115; // [rsp+F0h] [rbp-4078h]

  v4 = *(_QWORD *)param0;
  v5 = (__m128 *)*((_QWORD *)param0 + 1);
  v6 = gVmxOne_0;
  v7 = (_OWORD *)*((_QWORD *)param0 + 2);
  v8 = *((unsigned int *)param0 + 16);
  v9 = *((_QWORD *)param0 + 4);
  v10 = (unsigned __int8 *)*((_QWORD *)param0 + 13);
  ...
  if ( *((_WORD *)param0 + 20) )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        v28 = _mm_sub_ps(v6, _mm_mul_ps(v27, v24));
  ...
  v111 = gVmxOneOver255;
  v102 = gVmx127;
  _mm_store_si128(&v101, gVmxUnpackBias);
  v106 = gVmxUnpackMask;
  ...
  if ( (_DWORD)v8 )
  {
    ...
    do
    {
      ...
      v72 = _mm_mul_ps(v63, *(__m128 *)((char *)&v114 + v55));
      v73 = _mm_add_ps(
              _mm_add_ps(
                _mm_mul_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        ...
                        _mm_mul_ps(v69, *(__m128 *)((char *)&v113 + v52))),
                      _mm_mul_ps(v63, *(__m128 *)((char *)&v114 + v52))),
                    _mm_mul_ps(v70, *(__m128 *)((char *)&v115 + v52))),
                  v66),
                (__m128)0i64),
              _mm_mul_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      ...
                      _mm_mul_ps(v69, *(__m128 *)((char *)&v113 + v53))),
                    _mm_mul_ps(v63, *(__m128 *)((char *)&v114 + v53))),
                  _mm_mul_ps(v70, *(__m128 *)((char *)&v115 + v53))),
                v67));
      v74 = _mm_add_ps(
              _mm_add_ps(_mm_mul_ps(v59, v71), (__m128)0i64),
              _mm_mul_ps(v69, *(__m128 *)((char *)&v113 + v55)));
      v75 = _mm_add_ps(
              _mm_add_ps(_mm_mul_ps(v59, *(__m128 *)((char *)&v112 + v56)), (__m128)0i64),
              _mm_mul_ps(v69, *(__m128 *)((char *)&v113 + v56)));
      v76 = _mm_shuffle_ps(v65, v65, 85);
      v77 = _mm_add_ps(v75, _mm_mul_ps(v63, *(__m128 *)((char *)&v114 + v56)));
      v78 = _mm_shuffle_ps(v65, v65, 170);
      v79 = _mm_add_ps(_mm_add_ps(v74, v72), _mm_mul_ps(v70, *(__m128 *)((char *)&v115 + v55)));
      v80 = _mm_add_ps(v77, _mm_mul_ps(v70, *(__m128 *)((char *)&v115 + v56)));
                ...
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      ...
                      _mm_mul_ps(v76, *(__m128 *)((char *)&v113 + v52))),
                    _mm_mul_ps(v78, *(__m128 *)((char *)&v114 + v52))),
                  v84),
                v66),
              (__m128)0i64);
      v86 = _mm_mul_ps(
              _mm_add_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    ...
                    _mm_mul_ps(v76, *(__m128 *)((char *)&v113 + v53))),
                  _mm_mul_ps(v78, *(__m128 *)((char *)&v114 + v53))),
                v84),
              v67);
      v87 = v83;
      v88 = _mm_mul_ps(
              _mm_add_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    ...
                    _mm_mul_ps(v76, *(__m128 *)((char *)&v113 + v56))),
                  _mm_mul_ps(v78, *(__m128 *)((char *)&v114 + v56))),
                v84),
              v105);
      v89 = _mm_mul_ps(
              _mm_add_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    ...
                    _mm_mul_ps(v76, *(__m128 *)((char *)&v113 + v55))),
                  _mm_mul_ps(v78, *(__m128 *)((char *)&v114 + v55))),
                v84),
              v68);
                      ...
                      _mm_add_ps(
                        _mm_add_ps(
                          _mm_add_ps(
                            ...
                            _mm_mul_ps(v90, *(__m128 *)((char *)&v113 + v52))),
                          _mm_mul_ps(v91, *(__m128 *)((char *)&v114 + v52))),
                        v94),
                      v66),
                    (__m128)0i64),
                  _mm_mul_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        _mm_add_ps(
                          ...
                          _mm_mul_ps(v90, *(__m128 *)((char *)&v113 + v53))),
                        _mm_mul_ps(v91, *(__m128 *)((char *)&v114 + v53))),
                      v94),
                    v67)),
                _mm_mul_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        _mm_add_ps(_mm_mul_ps(v93, *(__m128 *)((char *)&v112 + v55)), (__m128)0i64),
                        _mm_mul_ps(v90, *(__m128 *)((char *)&v113 + v55))),
                      _mm_mul_ps(v91, *(__m128 *)((char *)&v114 + v55))),
                    v94),
                  v68)),
              _mm_mul_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      ...
                      _mm_mul_ps(v90, *(__m128 *)((char *)&v113 + v56))),
                    _mm_mul_ps(v91, *(__m128 *)((char *)&v114 + v56))),
                  v94),
                v105));
      v42 = v102;
      v6 = gVmxOne_0;
      ...
      *(__m128 *)((char *)v5 + v47) = _mm_shuffle_ps(v82, _mm_shuffle_ps(v82, (__m128)0i64, 250), 148);
      ...
      v98 = _mm_or_ps(_mm_andnot_ps(gVmxOne_0, _mm_cmpltps(v103, (__m128)0i64)), v104);
      *(_DWORD *)((char *)&v5->m128_u64[-1] + v47) = (unsigned __int128)_mm_packus_epi16(v97, v97);
      ...
      *(_DWORD *)((char *)v5->m128_u64 + v47 - 4) = (unsigned __int128)_mm_packus_epi16(v100, v100);
      --v48;
    }
    while ( v48 );
  }
}28)_mm_packus_epi16(v100, v100);
      --v48;
    }
    while ( v48 );
  }
...
// File Line: 18
// RVA: 0x1F580
void __fastcall Render::SkinMorphBufferTask(int worker_id, UFG::qMemoryStreamer *memory_streamer, void *param0, void *param1)
{
  __int64 v4; // rdi
  __m128 *v5; // rbp
  __m128 *v6; // r14
  ...
  __m128i v105; // xmm2
  __m128i v106; // xmm2
  __m128 v107; // [rsp+0h] [rbp-41B8h]
  __m128 v108; // [rsp+40h] [rbp-4178h]
  __int128 v109; // [rsp+50h] [rbp-4168h]
  ...
  __int128 v120; // [rsp+100h] [rbp-40B8h]
  __int128 v121; // [rsp+110h] [rbp-40A8h]
  __int128 v122; // [rsp+120h] [rbp-4098h]
  __int128 v123; // [rsp+130h] [rbp-4088h]

  v4 = *(_QWORD *)param0;
  v5 = (__m128 *)*((_QWORD *)param0 + 1);
  v6 = (__m128 *)*((_QWORD *)param0 + 2);
  v7 = (_OWORD *)*((_QWORD *)param0 + 6);
  v107.m128_i32[0] = *((_DWORD *)param0 + 14);
  v8 = gVmxOne_0;
  ...
  if ( *((_WORD *)param0 + 20) )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        v21 = v18[2];
        v22 = v18[3];
        v23 = _mm_shuffle_ps(*(__m128 *)(v17 + v10 + 16), v19, 255);
        v24 = _mm_add_ps(v19, v19);
        v25 = _mm_shuffle_ps(*(__m128 *)(v17 + v10 + 16), v19, 201);
        v26 = _mm_shuffle_ps(v24, v24, 210);
        v27 = _mm_shuffle_ps(v19, v19, 210);
        v28 = _mm_shuffle_ps(v24, v24, 201);
        v29 = _mm_sub_ps(v8, _mm_mul_ps(v28, v25));
        v30 = _mm_add_ps(_mm_add_ps(_mm_mul_ps(v28, v23), (__m128)0i64), _mm_mul_ps(v27, v24));
        v31 = _mm_sub_ps(_mm_add_ps(_mm_mul_ps(v25, v24), (__m128)0i64), _mm_mul_ps(v26, v23));
        v32 = _mm_sub_ps(v29, _mm_mul_ps(v26, v27));
        v33 = _mm_shuffle_ps(_mm_shuffle_ps(v30, v31, 80), v31, 233);
        v34 = _mm_shuffle_ps(_mm_shuffle_ps(v31, v32, 80), v32, 233);
        v35 = _mm_shuffle_ps(_mm_shuffle_ps(v32, v30, 80), v30, 233);
  ...
  v113 = gVmxOneOver511;
  v118 = gVmxi127;
  _mm_store_si128((__m128i *)&v109, gVmxUnpackBias);
  v110 = gVmxUnpackMask;
  v116 = gVmxUnpackUnbias;
  v112 = gVmxUnpackShift;
  if ( (_DWORD)v9 )
  {
    v50 = _mm_shuffle_ps(v107, v107, 0);
    v51 = v4 - (_QWORD)v5;
    v52 = v9;
    ...
    do
    {
      ...
      v54 = v5[1];
      v7 = (_OWORD *)((char *)v7 + 8);
      v55 = LOBYTE(v6->m128_u64[0]) << 6;
      v56 = BYTE1(v6->m128_u64[0]) << 6;
      v57 = (__m128i)_mm_and_ps(_mm_shuffle_ps(v53, _mm_shuffle_ps(v53, v46, 0), 144), v47);
      v58 = *v6;
      v59 = BYTE2(v6->m128_u64[0]) << 6;
      v60 = BYTE3(v6->m128_u64[0]);
      v6 = (__m128 *)((char *)v6 + 8);
      ...
      v64 = _mm_load_si128((const __m128i *)&v109);
      ...
      v70 = _mm_add_ps(
              ...
              _mm_add_ps(
                _mm_mul_ps(
                  ...
                  v50),
                v13));
      v71 = _mm_add_ps(_mm_shuffle_ps(*v5, _mm_shuffle_ps(*v5, v8, 250), 148), _mm_add_ps(v66, v13));
      v72 = _mm_shuffle_ps(v68, _mm_shuffle_ps(v68, v13, 250), 148);
      v73 = _mm_shuffle_ps(v67, v67, 0);
      v74 = _mm_shuffle_ps(v67, v67, 85);
      v75 = _mm_shuffle_ps(v70, v70, 0);
      v76 = _mm_shuffle_ps(v70, v70, 85);
      v77 = _mm_shuffle_ps(v70, v70, 170);
      v78 = _mm_shuffle_ps(v67, v67, 170);
      v79 = _mm_shuffle_ps(v67, v67, 255);
      v80 = _mm_add_ps(
              _mm_mul_ps(
                _mm_rsqrt_ps(
                  _mm_add_ps(
                    _mm_add_ps(_mm_add_ps(_mm_mul_ps(v75, v75), v13), _mm_mul_ps(v76, v76)),
                    _mm_mul_ps(v77, v77))),
                v70),
              (__m128)0i64);
      v81 = _mm_shuffle_ps(v71, v71, 0);
      v82 = _mm_shuffle_ps(v71, v71, 85);
      v83 = _mm_shuffle_ps(v80, v80, 0);
      v84 = _mm_shuffle_ps(v80, v80, 85);
      v85 = _mm_shuffle_ps(v80, v80, 170);
      v86 = _mm_add_ps(
              _mm_add_ps(
                _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(v72, v72, 0), v83), (__m128)0i64),
                _mm_mul_ps(_mm_shuffle_ps(v72, v72, 85), v84)),
              _mm_mul_ps(_mm_shuffle_ps(v72, v72, 170), v85));
      v87 = _mm_sub_ps(
              v72,
              _mm_sub_ps(
                _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(v86, v86, 201), _mm_shuffle_ps(v80, v80, 210)), (__m128)0i64),
                _mm_mul_ps(_mm_shuffle_ps(v86, v86, 210), _mm_shuffle_ps(v80, v80, 201))));
      v88 = _mm_shuffle_ps(v87, v87, 0);
      v89 = _mm_shuffle_ps(v87, v87, 85);
      v90 = _mm_shuffle_ps(v87, v87, 170);
      v91 = _mm_mul_ps(
              _mm_rsqrt_ps(
                _mm_add_ps(
                  _mm_add_ps(_mm_add_ps(_mm_mul_ps(v88, v88), (__m128)0i64), _mm_mul_ps(v89, v89)),
                  _mm_mul_ps(v90, v90))),
              v87);
      v92 = _mm_shuffle_ps(v71, v71, 170);
      v111 = _mm_add_ps(v91, (__m128)0i64);
      v93 = _mm_shuffle_ps(v71, v71, 255);
      v94 = _mm_mul_ps(_mm_shuffle_ps(v80, v80, 255), (__m128)0i64);
      v95 = _mm_add_ps(
              _mm_add_ps(
                _mm_add_ps(
                  _mm_add_ps(
                      ...
                      _mm_add_ps(
                        _mm_add_ps(
                          _mm_add_ps(
                            ...
                            _mm_mul_ps(v82, *(__m128 *)((char *)&v121 + v55))),
                          _mm_mul_ps(v92, *(__m128 *)((char *)&v122 + v55))),
                        _mm_mul_ps(v93, *(__m128 *)((char *)&v123 + v55))),
                      v73),
                    (__m128)0i64),
                  _mm_mul_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        _mm_add_ps(
                          ...
                          _mm_mul_ps(v82, *(__m128 *)((char *)&v121 + v56))),
                        _mm_mul_ps(v92, *(__m128 *)((char *)&v122 + v56))),
                      _mm_mul_ps(v93, *(__m128 *)((char *)&v123 + v56))),
                    v74)),
                _mm_mul_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        ...
                        _mm_mul_ps(v82, *(__m128 *)((char *)&v121 + v59))),
                      _mm_mul_ps(v92, *(__m128 *)((char *)&v122 + v59))),
                    _mm_mul_ps(v93, *(__m128 *)((char *)&v123 + v59))),
                  v78)),
              _mm_mul_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      ...
                      _mm_mul_ps(v82, *(__m128 *)((char *)&v121 + v60))),
                    _mm_mul_ps(v92, *(__m128 *)((char *)&v122 + v60))),
                  _mm_mul_ps(v93, *(__m128 *)((char *)&v123 + v60))),
                v79));
      v96 = _mm_shuffle_ps(v111, v111, 0);
      v97 = _mm_shuffle_ps(v111, v111, 85);
      v98 = _mm_shuffle_ps(v111, v111, 170);
      v99 = _mm_add_ps(
              _mm_add_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_mul_ps(
                      _mm_add_ps(
                        _mm_add_ps(
                          _mm_add_ps(
                            _mm_add_ps(_mm_mul_ps(v83, *(__m128 *)((char *)&v120 + v55)), (__m128)0i64),
                            _mm_mul_ps(v84, *(__m128 *)((char *)&v121 + v55))),
                          _mm_mul_ps(v85, *(__m128 *)((char *)&v122 + v55))),
                        v94),
                      v73),
                    (__m128)0i64),
                  _mm_mul_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        _mm_add_ps(
                          _mm_add_ps(_mm_mul_ps(v83, *(__m128 *)((char *)&v120 + v56)), (__m128)0i64),
                          _mm_mul_ps(v84, *(__m128 *)((char *)&v121 + v56))),
                        _mm_mul_ps(v85, *(__m128 *)((char *)&v122 + v56))),
                      v94),
                    v74)),
                _mm_mul_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        _mm_add_ps(_mm_mul_ps(v83, *(__m128 *)((char *)&v120 + v59)), (__m128)0i64),
                        _mm_mul_ps(v84, *(__m128 *)((char *)&v121 + v59))),
                      _mm_mul_ps(v85, *(__m128 *)((char *)&v122 + v59))),
                    v94),
                  v78)),
              _mm_mul_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      _mm_add_ps(_mm_mul_ps(v83, *(__m128 *)((char *)&v120 + v60)), (__m128)0i64),
                      _mm_mul_ps(v84, *(__m128 *)((char *)&v121 + v60))),
                    _mm_mul_ps(v85, *(__m128 *)((char *)&v122 + v60))),
                  v94),
                v79));
      v13 = 0i64;
      v100 = _mm_mul_ps(_mm_shuffle_ps(v111, v111, 255), (__m128)0i64);
      v101 = _mm_add_ps(
               _mm_add_ps(
                 _mm_add_ps(
                   _mm_add_ps(
                     _mm_mul_ps(
                       _mm_add_ps(
                         _mm_add_ps(
                           _mm_add_ps(
                             _mm_add_ps(_mm_mul_ps(v96, *(__m128 *)((char *)&v120 + v55)), (__m128)0i64),
                             _mm_mul_ps(v97, *(__m128 *)((char *)&v121 + v55))),
                           _mm_mul_ps(v98, *(__m128 *)((char *)&v122 + v55))),
                         v100),
                       v73),
                     (__m128)0i64),
                   _mm_mul_ps(
                     _mm_add_ps(
                       _mm_add_ps(
                         _mm_add_ps(
                           _mm_add_ps(_mm_mul_ps(v96, *(__m128 *)((char *)&v120 + v56)), (__m128)0i64),
                           _mm_mul_ps(v97, *(__m128 *)((char *)&v121 + v56))),
                         _mm_mul_ps(v98, *(__m128 *)((char *)&v122 + v56))),
                       v100),
                     v74)),
                 _mm_mul_ps(
                   _mm_add_ps(
                     _mm_add_ps(
                       _mm_add_ps(
                         _mm_add_ps(_mm_mul_ps(v96, *(__m128 *)((char *)&v120 + v59)), (__m128)0i64),
                         _mm_mul_ps(v97, *(__m128 *)((char *)&v121 + v59))),
                       _mm_mul_ps(v98, *(__m128 *)((char *)&v122 + v59))),
                     v100),
                   v78)),
               _mm_mul_ps(
                 _mm_add_ps(
                   _mm_add_ps(
                     _mm_add_ps(
                       _mm_add_ps(_mm_mul_ps(v96, *(__m128 *)((char *)&v120 + v60)), (__m128)0i64),
                       _mm_mul_ps(v97, *(__m128 *)((char *)&v121 + v60))),
                     _mm_mul_ps(v98, *(__m128 *)((char *)&v122 + v60))),
                   v100),
                 v79));
      v44 = v119;
      v8 = gVmxOne_0;
      v50 = v108;
      *(__m128 *)((char *)v5 + v51) = _mm_shuffle_ps(v95, _mm_shuffle_ps(v95, (__m128)0i64, 250), 148);
      v5 = (__m128 *)((char *)v5 + 24);
      v49 = v112;
      v45 = v114;
      v48 = v116;
      v46 = (__m128)v118;
      v102 = _mm_cvtps_epi32(_mm_cvtepi32_ps(_mm_cvtps_epi32(_mm_add_ps(_mm_mul_ps(v99, v44), v44))));
      v103 = _mm_packs_epi32(v102, v102);
      *(_DWORD *)((char *)&v5->m128_u64[-1] + v51) = (unsigned __int128)_mm_packus_epi16(v103, v103);
      v104 = _mm_cvtps_epi32(
               _mm_add_ps(
                 _mm_mul_ps(
                   _mm_shuffle_ps(
                     v101,
                     _mm_shuffle_ps(
                       v101,
                       _mm_or_ps(_mm_andnot_ps(gVmxOne_0, _mm_cmpltps(v69, (__m128)0i64)), v117),
                       250),
                     148),
                   v44),
                 v44));
      v47 = (__m128)v110;
      v105 = _mm_cvtps_epi32(_mm_cvtepi32_ps(v104));
      v106 = _mm_packs_epi32(v105, v105);
      *(_DWORD *)((char *)v5->m128_u64 + v51 - 4) = (unsigned __int128)_mm_packus_epi16(v106, v106);
      --v52;
    }
    while ( v52 );
  }
}_int128)_mm_packus_epi16(v106, v106);
      --v52;
    }
    while ( v52 );
  }
...
// File Line: 23
// RVA: 0x20000
void __fastcall Render::SkinCacheBufferTask(int worker_id, UFG::qMemoryStreamer *memory_streamer, void *param0, void *param1)
{
  __int64 v4; // rsi
  __int64 v5; // rbp
  __m128 v6; // xmm6
  ...
  __m128i v103; // xmm2
  __m128i v104; // xmm2
  __m128i v105; // [rsp+10h] [rbp-4168h]
  ...
  __int128 v116; // [rsp+C0h] [rbp-40B8h]
  __int128 v117; // [rsp+D0h] [rbp-40A8h]
  __int128 v118; // [rsp+E0h] [rbp-4098h]
  __int128 v119; // [rsp+F0h] [rbp-4088h]
  ...
  if ( *((_WORD *)param0 + 20) )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        v21 = v18[2];
        v22 = v18[3];
        v23 = _mm_shuffle_ps(*(__m128 *)(v17 + v11 + 16), v19, 255);
        v24 = _mm_add_ps(v19, v19);
        v25 = _mm_shuffle_ps(*(__m128 *)(v17 + v11 + 16), v19, 201);
        v26 = _mm_shuffle_ps(v24, v24, 210);
        v27 = _mm_shuffle_ps(v19, v19, 210);
        v28 = _mm_shuffle_ps(v24, v24, 201);
        v29 = _mm_sub_ps(v6, _mm_mul_ps(v28, v25));
        v30 = _mm_add_ps(_mm_add_ps(_mm_mul_ps(v28, v23), (__m128)0i64), _mm_mul_ps(v27, v24));
        v31 = _mm_sub_ps(_mm_add_ps(_mm_mul_ps(v25, v24), (__m128)0i64), _mm_mul_ps(v26, v23));
        v32 = _mm_sub_ps(v29, _mm_mul_ps(v26, v27));
        v33 = _mm_shuffle_ps(_mm_shuffle_ps(v30, v31, 80), v31, 233);
  ...
  v115 = gVmxOneOver255;
  v106 = gVmx127;
  _mm_store_si128(&v105, gVmxUnpackBias);
  v110 = gVmxUnpackMask;
  ...
  if ( (_DWORD)v9 )
  {
    ...
    do
    {
      ...
      v75 = _mm_mul_ps(v66, *(__m128 *)((char *)&v118 + v58));
      v76 = _mm_add_ps(
              _mm_add_ps(
                _mm_mul_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        ...
                        _mm_mul_ps(v72, *(__m128 *)((char *)&v117 + v55))),
                      _mm_mul_ps(v66, *(__m128 *)((char *)&v118 + v55))),
                    _mm_mul_ps(v73, *(__m128 *)((char *)&v119 + v55))),
                  v69),
                (__m128)0i64),
              _mm_mul_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      ...
                      _mm_mul_ps(v72, *(__m128 *)((char *)&v117 + v56))),
                    _mm_mul_ps(v66, *(__m128 *)((char *)&v118 + v56))),
                  _mm_mul_ps(v73, *(__m128 *)((char *)&v119 + v56))),
                v70));
      v77 = _mm_add_ps(
              _mm_add_ps(_mm_mul_ps(v62, v74), (__m128)0i64),
              _mm_mul_ps(v72, *(__m128 *)((char *)&v117 + v58)));
      v78 = _mm_add_ps(
              _mm_add_ps(_mm_mul_ps(v62, *(__m128 *)((char *)&v116 + v59)), (__m128)0i64),
              _mm_mul_ps(v72, *(__m128 *)((char *)&v117 + v59)));
      v79 = _mm_shuffle_ps(v68, v68, 85);
      v80 = _mm_add_ps(v78, _mm_mul_ps(v66, *(__m128 *)((char *)&v118 + v59)));
      v81 = _mm_shuffle_ps(v68, v68, 170);
      v82 = _mm_add_ps(_mm_add_ps(v77, v75), _mm_mul_ps(v73, *(__m128 *)((char *)&v119 + v58)));
      v83 = _mm_add_ps(v80, _mm_mul_ps(v73, *(__m128 *)((char *)&v119 + v59)));
                ...
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      ...
                      _mm_mul_ps(v79, *(__m128 *)((char *)&v117 + v55))),
                    _mm_mul_ps(v81, *(__m128 *)((char *)&v118 + v55))),
                  v87),
                v69),
              (__m128)0i64);
      v89 = _mm_mul_ps(
              _mm_add_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    ...
                    _mm_mul_ps(v79, *(__m128 *)((char *)&v117 + v56))),
                  _mm_mul_ps(v81, *(__m128 *)((char *)&v118 + v56))),
                v87),
              v70);
      v90 = v86;
      v91 = _mm_mul_ps(
              _mm_add_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    ...
                    _mm_mul_ps(v79, *(__m128 *)((char *)&v117 + v59))),
                  _mm_mul_ps(v81, *(__m128 *)((char *)&v118 + v59))),
                v87),
              v109);
      v92 = _mm_mul_ps(
              _mm_add_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    ...
                    _mm_mul_ps(v79, *(__m128 *)((char *)&v117 + v58))),
                  _mm_mul_ps(v81, *(__m128 *)((char *)&v118 + v58))),
                v87),
              v71);
                      ...
                      _mm_add_ps(
                        _mm_add_ps(
                          _mm_add_ps(
                            ...
                            _mm_mul_ps(v93, *(__m128 *)((char *)&v117 + v55))),
                          _mm_mul_ps(v94, *(__m128 *)((char *)&v118 + v55))),
                        v97),
                      v69),
                    (__m128)0i64),
                  _mm_mul_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        _mm_add_ps(
                          ...
                          _mm_mul_ps(v93, *(__m128 *)((char *)&v117 + v56))),
                        _mm_mul_ps(v94, *(__m128 *)((char *)&v118 + v56))),
                      v97),
                    v70)),
                _mm_mul_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      _mm_add_ps(
                        _mm_add_ps(_mm_mul_ps(v96, *(__m128 *)((char *)&v116 + v58)), (__m128)0i64),
                        _mm_mul_ps(v93, *(__m128 *)((char *)&v117 + v58))),
                      _mm_mul_ps(v94, *(__m128 *)((char *)&v118 + v58))),
                    v97),
                  v71)),
              _mm_mul_ps(
                _mm_add_ps(
                  _mm_add_ps(
                    _mm_add_ps(
                      ...
                      _mm_mul_ps(v93, *(__m128 *)((char *)&v117 + v59))),
                    _mm_mul_ps(v94, *(__m128 *)((char *)&v118 + v59))),
                  v97),
                v109));
      v43 = v106;
      v6 = gVmxOne_0;
      ...
      *(__m128 *)(v49 - 16) = v98;
      ...
      v101.m128i_i32[0] = (unsigned __int128)_mm_packus_epi16(v101, v101);
      v102 = _mm_or_ps(_mm_andnot_ps(gVmxOne_0, _mm_cmpltps(v107, (__m128)0i64)), v108);
      ...
      *(_DWORD *)(v49 - 24) = v101.m128i_i32[0];
      ...
      v104.m128i_i32[0] = (unsigned __int128)_mm_packus_epi16(v104, v104);
...
}mm_cvtps_epi32(_mm_cvtepi32_ps(_mm_cvtps_epi32(_mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(v99, _mm_shuffle_ps(v99, v102, 250), 148), v43), v43))));
      v104 = _mm_packs_epi32(v103, v103);
      v104.m128i_i32[0] = (unsigned __int128)_mm_packus_epi16(v
