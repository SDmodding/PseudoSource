...
// File Line: 43
// RVA: 0x14C610
signed __int64 __fastcall UFG::AudioFilePackageLUT::Setup(UFG::AudioFilePackageLUT *this, char *in_pData, unsigned int in_uHeaderSize)
{
  char *v3; // r11
  char *v4; // r10
...
// File Line: 108
// RVA: 0x148E50
UFG::AudioFilePackageLUT::FileLUT *__fastcall UFG::AudioFilePackageLUT::LookupFile(UFG::AudioFilePackageLUT *this, unsigned int in_uID, UFG::AudioFilePackageLUT::FileLUT *in_pLut, bool in_bIsLanguageSpecific)
{
  int v4; // er9
  int v5; // er10
...
// File Line: 181
// RVA: 0x146640
signed __int64 __fastcall UFG::AudioFilePackageLUT::GetSoundBankID(UFG::AudioFilePackageLUT *this, const wchar_t *in_pszBankName)
{
...
// File Line: 210
// RVA: 0x145DD0
__int64 __fastcall UFG::AudioFilePackageLUT::StringMap::GetID(UFG::AudioFilePackageLUT::StringMap *this, const wchar_t *in_pszString)
{
  unsigned __int64 v2; // rbx
  const wchar_t *v3; // r8
  UFG::AudioFilePackageLUT::StringMap *v4; // r14
  ...
  wcsncpy_s((unsigned __int16 *)_Dst, v6, v3, v11);
  _Dst[v11] = 0;
  do
    ++v2;
  while ( _Dst[v2] );
  ...
  v16 = 0;
  v17 = v4->m_uNumStrings - 1;
  while ( 1 )
  {
    v18 = v16 + (v17 - v16) / 2;
    v19 = (char *)v4 + v4[2 * v18 + 1].m_uNumStrings;
    ...
    v22 = -(v21 < *(_WORD *)&v20[(_QWORD)v19]) | 1;
LABEL_23:
    if ( !v22 )
      return v4[2 * v18 + 2].m_uNumStrings;
    if ( v22 <= 0 )
      v16 = v18 + 1;
    else
      v17 = v18 - 1;
