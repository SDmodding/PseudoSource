...
__int64 dynamic_initializer_for__SimSym_InventoryType__()
{
  ...
  return atexit(dynamic_atexit_destructor_for__SimSym_InventoryType__);
}
...
__int64 dynamic_initializer_for__SimSymX_propset_componentVehicleProperties__()
{
  ...
  return atexit(dynamic_atexit_destructor_for__SimSymX_propset_componentVehicleProperties__);
}
