...
AK::IAkPluginParam *__fastcall CAkFxSrcMP3Params::Clone(CAkFxSrcMP3Params *this, AK::IAkPluginMemAlloc *in_pAllocator)
{
  ...
  result->vfptr = (AK::IAkRTPCSubscriberVtbl *)&AK::IAkPluginParam::`vftable;
  result->vfptr = (AK::IAkRTPCSubscriberVtbl *)&CAkFxSrcMP3Params::`vftable;
  LODWORD(result[1].vfptr) = this->m_Params.uToken;
  return result;
}

// File Line: 52
// RVA: 0xA360B0
__int64 __fastcall CAkFxSrcMP3Params::Init(
        CAkFxSrcMP3Params *this,
...
// File Line: 74
// RVA: 0xA36530
__int64 __fastcall CAkFxSrcMP3Params::SetParamsBlock(
        CAkFxSrcMP3Params *this,
        unsigned int *in_pParamsBlock,
        unsigned int in_ulBlockSize)
{
  this->m_Params.uToken = *in_pParamsBlock;
  return 1i64;
}

// File Line: 87
// RVA: 0xA36510
signed __int64 __fastcall CAkFxSrcMP3Params::SetParam(
        CAkFxSrcMP3Params *this,
        __int16 in_ParamID,
        ...
        unsigned int in_ulParamSize)
{
  if ( !in_pValue || in_ParamID )
    return 31i64;
  this->m_Params.uToken = *in_pValue;
  return 1i64;
}
