...
bool __fastcall Illusion::IPrimitivePlat::SetBuffers(Illusion::IPrimitivePlat *this, bool dupe_vertex_buffer)
{
  ...
  if ( dupe_vertex_buffer )
  {
    ...
    if ( !v4 )
      return (char)v4;
    memmove(v4, *(const void **)this, v3);
    *(_QWORD *)&this[48] = Illusion::gPrimitiveFrameWriteMemoryPlat.mBuffer[Illusion::gPrimitiveFrameWriteMemoryPlat.mFrameMemoryBufferIndex];
    *(_DWORD *)&this[56] = v5 - LODWORD(Illusion::gPrimitiveFrameWriteMemoryPlat.mLockData);
  }
  else
  {
...
LABEL_28:
      *(_QWORD *)&this[64] = Illusion::gPrimitiveFrameWriteMemoryPlat.mBuffer[Illusion::gPrimitiveFrameWriteMemoryPlat.mFrameMemoryBufferIndex];
