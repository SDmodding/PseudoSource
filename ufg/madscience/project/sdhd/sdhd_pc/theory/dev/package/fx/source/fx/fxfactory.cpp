// File Line: 574
// RVA: 0x1C6850
void __fastcall Render::FXSettingsInventoryTemplate<Render::DynamicLightSettings,3603788052,2366538547>::Add(SimpleXML::XMLFileInventory *this, UFG::qResourceData *resource_data)
{
  UFG::qResourceData *v2; // rbx
  SimpleXML::XMLFileInventory *v3; // rdi
...
// File Line: 583
// RVA: 0x1D25B0
void __fastcall Render::FXSettingsInventoryTemplate<Render::ParticleEmitterSettings,1005461980,3495651702>::Remove(Render::FXSettingsInventoryTemplate<Render::ParticleEmitterSettings,1005461980,3495651702> *this, UFG::qResourceData *resource_data)
{
  Render::ParticleEmitterSettings *v2; // rbx

  v2 = (Render::ParticleEmitterSettings *)resource_data;
  UFG::qResourceInventory::Remove((UFG::qResourceInventory *)&this->vfptr, resource_data);
  Render::ParticleEmitterSettings::~ParticleEmitterSettings(v2);
}
...
__int64 Render::_dynamic_initializer_for__gDecalSettingsInventory__()
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gDecalSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gBeamSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gEffectEmitterSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gParticleSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gFlareSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gFXSettingsInventory.vfptr,
    "FXSettingsInventory",
    0xED341A8D,
    0x12289ADBu,
    0,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gAudioFXSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gCoronaFlareSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gDynamicLightSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gDynamicLightGroupSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gFXForceInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gScreenParticleSettingsInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gLightningInventory.vfptr,
...
{
  UFG::qResourceInventory::qResourceInventory(
    (UFG::qResourceInventory *)&Render::gVolumetricEffectSettingsInventory.vfptr,
