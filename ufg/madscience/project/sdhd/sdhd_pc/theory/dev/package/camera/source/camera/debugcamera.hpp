...
UFG::ComponentIDDesc *__fastcall UFG::DebugCameraComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::DebugCameraComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::DebugCameraComponent::_TypeIDesc.mBaseTypeIndex = v3;
    ...
    UFG::DebugCameraComponent::_TypeUID = v1 | ((unsigned __int16)v3 << 25);
    UFG::DebugCameraComponent::_DebugCameraComponentTypeUID = v1 | ((unsigned __int16)v3 << 25);
  }
