...
__int64 dynamic_initializer_for__kIrradCaptureShaderSymbol__()
{
  ...
  return atexit((int (__fastcall *)())dynamic_atexit_destructor_for__kIrradCaptureShaderSymbol__);
}
...
UFG::ComponentIDDesc *__fastcall EditorCaptureSkyContext::AccessComponentDesc()
{
  ...
  if ( !EditorCaptureSkyContext::_DescInit )
  {
    ...
    *(_DWORD *)&EditorCaptureSkyContext::_TypeIDesc.mBaseTypeIndex = v3;
    ...
    EditorCaptureSkyContext::_TypeUID = v1 | ((unsigned __int16)v3 << 25);
    EditorCaptureSkyContext::_EditorCaptureSkyContextTypeUID = v1 | ((unsigned __int16)v3 << 25);
  }
...
__int64 SkyIrradGridGenerator::_dynamic_initializer_for__msZoneFilter__()
{
  ...
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msZoneFilter__);
}
...
{
  UFG::qString::qString(&msSectionFilter, &customCaption);
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msSectionFilter__);
}
...
__int64 SkyIrradGridGenerator::_dynamic_initializer_for__msLayerName__()
{
  ...
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msLayerName__);
}
...
__int64 SkyIrradGridGenerator::_dynamic_initializer_for__msSkyIrradParent__()
{
  ...
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msSkyIrradParent__);
}
...
__int64 SkyIrradGridGenerator::_dynamic_initializer_for__msComponentIrradianceVolumeName__()
{
  ...
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msComponentIrradianceVolumeName__);
}
...
__int64 SkyIrradGridGenerator::_dynamic_initializer_for__msComponentIrradianceVolumeSchema__()
{
  ...
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msComponentIrradianceVolumeSchema__);
}
...
__int64 SkyIrradGridGenerator::_dynamic_initializer_for__msComponentRegionName__()
{
  ...
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msComponentRegionName__);
}
...
__int64 SkyIrradGridGenerator::_dynamic_initializer_for__msRegionMin__()
{
  ...
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msRegionMin__);
}
...
__int64 SkyIrradGridGenerator::_dynamic_initializer_for__msRegionMax__()
{
  ...
  return atexit((int (__fastcall *)())SkyIrradGridGenerator::_dynamic_atexit_destructor_for__msRegionMax__);
}
