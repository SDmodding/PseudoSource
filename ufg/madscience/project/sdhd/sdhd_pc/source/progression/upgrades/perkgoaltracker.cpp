...
{
  UFG::qMap<enum UFG::PerkGoalTracker::ePERK_GOAL> *p_m_hashLookup; // rsi
  unsigned int v3; // eax
  unsigned int v4; // ebp
  ...
  p_m_hashLookup = &this->m_hashLookup;
  UFG::qBaseTreeRB::qBaseTreeRB(&this->m_hashLookup.mTree.mTree);
  this->m_maxGoalProgress[0] = 5;
  this->m_maxGoalProgress[1] = 1;
  this->m_maxGoalProgress[2] = 5;
  this->m_maxGoalProgress[3] = 1;
  this->m_maxGoalProgress[4] = 5;
  v3 = UFG::qStringHash32("no_civilians", 0xFFFFFFFF);
  v4 = v3;
  if ( !v3 || (v5 = UFG::qBaseTreeRB::Get(&p_m_hashLookup->mTree.mTree, v3)) == 0i64 )
  {
    ...
    UFG::qBaseTreeRB::Add(&p_m_hashLookup->mTree.mTree, &v5->mRoot);
  }
  LODWORD(v5->mNULL.mParent) = 0;
  v7 = UFG::qStringHash32("no_cops", 0xFFFFFFFF);
  v8 = v7;
  if ( !v7 || (v9 = UFG::qBaseTreeRB::Get(&p_m_hashLookup->mTree.mTree, v7)) == 0i64 )
  {
    ...
    UFG::qBaseTreeRB::Add(&p_m_hashLookup->mTree.mTree, &v9->mRoot);
  }
  LODWORD(v9->mNULL.mParent) = 1;
  v11 = UFG::qStringHash32("no_kills", 0xFFFFFFFF);
  v12 = v11;
  if ( !v11 || (v13 = UFG::qBaseTreeRB::Get(&p_m_hashLookup->mTree.mTree, v11)) == 0i64 )
  {
    ...
    UFG::qBaseTreeRB::Add(&p_m_hashLookup->mTree.mTree, &v13->mRoot);
  }
  LODWORD(v13->mNULL.mParent) = 2;
  v15 = UFG::qStringHash32("no_alerts", 0xFFFFFFFF);
  v16 = v15;
  if ( !v15 || (v17 = UFG::qBaseTreeRB::Get(&p_m_hashLookup->mTree.mTree, v15)) == 0i64 )
  {
    ...
    UFG::qBaseTreeRB::Add(&p_m_hashLookup->mTree.mTree, &v17->mRoot);
  }
  LODWORD(v17->mNULL.mParent) = 3;
  v19 = UFG::qStringHash32("no_property_damage", 0xFFFFFFFF);
  v20 = v19;
  if ( !v19 || (v21 = UFG::qBaseTreeRB::Get(&p_m_hashLookup->mTree.mTree, v19)) == 0i64 )
  {
    ...
    UFG::qBaseTreeRB::Add(&p_m_hashLookup->mTree.mTree, &v21->mRoot);
  }
  LODWORD(v21->mNULL.mParent) = 4;
  *(_WORD *)&this->m_perks[0].active = 0;
  *(_QWORD *)&this->m_perks[0].currentProgress = 0i64;
  this->m_perks[0].maxProgress = this->m_maxGoalProgress[0];
  *(_WORD *)&this->m_perks[1].active = 0;
  *(_QWORD *)&this->m_perks[1].currentProgress = 0i64;
  this->m_perks[1].maxProgress = this->m_maxGoalProgress[1];
  *(_WORD *)&this->m_perks[2].active = 0;
  *(_QWORD *)&this->m_perks[2].currentProgress = 0i64;
  this->m_perks[2].maxProgress = this->m_maxGoalProgress[2];
  *(_WORD *)&this->m_perks[3].active = 0;
  *(_QWORD *)&this->m_perks[3].currentProgress = 0i64;
  this->m_perks[3].maxProgress = this->m_maxGoalProgress[3];
  *(_WORD *)&this->m_perks[4].active = 0;
  *(_QWORD *)&this->m_perks[4].currentProgress = 0i64;
  this->m_perks[4].maxProgress = this->m_maxGoalProgress[4];
}

// File Line: 94
// RVA: 0x4A5620
__int64 __fastcall UFG::PerkGoalTracker::GetNumGoalsSatisfied(UFG::PerkGoalTracker *this)
{
  __int64 result; // rax
  ...
  if ( this->m_perks[3].active && !this->m_perks[3].failed )
    result = (unsigned int)(result + 1);
  if ( this->m_perks[4].active && !this->m_perks[4].failed )
