...
__int64 UFG::_dynamic_initializer_for__qSymbolX_GameStatEventSymbol_FSR_Berserk__()
{
  ...
  return atexit(UFG::_dynamic_atexit_destructor_for__qSymbolX_GameStatEventSymbol_FSR_Berserk__);
}
...
__int64 UFG::_dynamic_initializer_for__gGameStatEventChannel__()
{
  ...
  return atexit(UFG::_dynamic_atexit_destructor_for__gGameStatEventChannel__);
}
