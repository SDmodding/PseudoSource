...
UFG::ComponentIDDesc *__fastcall UFG::GameCameraComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::GameCameraComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::GameCameraComponent::_TypeIDesc.mBaseTypeIndex = v3;
    ...
    UFG::GameCameraComponent::_TypeUID = v1 | ((unsigned __int16)v3 << 25);
    UFG::GameCameraComponent::_GameCameraComponentTypeUID = v1 | ((unsigned __int16)v3 << 25);
  }
...
UFG::ComponentIDDesc *__fastcall UFG::GameSubject::AccessComponentDesc()
{
  ...
  if ( !UFG::GameSubject::_DescInit )
  {
    ...
    LOWORD(v3) = v0->mBaseTypeIndex;
    *(_DWORD *)&UFG::GameSubject::_TypeIDesc.mBaseTypeIndex = v3;
    UFG::GameSubject::_TypeIDesc.mChildBitMask = v1;
    UFG::GameSubject::_TypeIDesc.mChildren = 0;
    UFG::GameSubject::_DescInit = 1;
    UFG::GameSubject::_TypeUID = v1 | ((unsigned __int16)v3 << 25);
    UFG::GameSubject::_GameSubjectTypeUID = v1 | ((unsigned __int16)v3 << 25);
  }
