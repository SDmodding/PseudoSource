...
UFG::ComponentIDDesc *__fastcall UFG::AnimatedCameraComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::AnimatedCameraComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::AnimatedCameraComponent::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::AnimatedCameraComponent::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::AnimatedCameraComponent::_AnimatedCameraComponentTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
...
// File Line: 50
// RVA: 0x3C3DE0
UFG::SimObject *__fastcall UFG::AnimatedCameraComponent::GetTarget(UFG::ProgressionCameraComponent *this)
{
