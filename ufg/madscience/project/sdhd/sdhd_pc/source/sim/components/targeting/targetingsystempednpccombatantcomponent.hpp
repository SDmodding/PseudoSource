...
UFG::ComponentIDDesc *__fastcall UFG::TargetingSystemPedNPCCombatantComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::TargetingSystemPedNPCCombatantComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::TargetingSystemPedNPCCombatantComponent::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::TargetingSystemPedNPCCombatantComponent::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::TargetingSystemPedNPCCombatantComponent::_TargetingSystemPedNPCCombatantComponentTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
