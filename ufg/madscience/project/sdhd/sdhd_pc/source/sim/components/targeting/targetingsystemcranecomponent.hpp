...
UFG::ComponentIDDesc *__fastcall UFG::TargetingSystemCraneComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::TargetingSystemCraneComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::TargetingSystemCraneComponent::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::TargetingSystemCraneComponent::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::TargetingSystemCraneComponent::_TargetingSystemCraneComponentTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
