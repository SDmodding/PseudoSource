// File Line: 70
// RVA: 0x4520E0
void __fastcall UFG::PhysicsBoat::operator delete(void *ptr, unsigned __int64 size)
{
    ...
    && ptr >= UFG::PhysicsVehicle::mAllocator.mBuffer )
  {
    *(_QWORD *)ptr = UFG::PhysicsVehicle::mAllocator.mFreeListHead;
    ...
    UFG::PhysicsVehicle::mAllocator.mFreeListHead = (char *)ptr;
  }
  else
  {
