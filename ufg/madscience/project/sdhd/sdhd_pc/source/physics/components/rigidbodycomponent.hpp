...
UFG::ComponentIDDesc *__fastcall UFG::RigidBodyComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::RigidBodyComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::RigidBodyComponent::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::RigidBodyComponent::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::RigidBodyComponent::_RigidBodyComponentTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
...
UFG::allocator::free_link *__fastcall UFG::RigidBodyComponent::operator new(unsigned __int64 size)
{
  ...
  v1 = UFG::RigidBodyComponent::mAllocator.mFreeListHead;
  ...
  return (UFG::allocator::free_link *)v1;
}

// File Line: 61
// RVA: 0x452140
void __fastcall UFG::RigidBodyComponent::operator delete(void *ptr, unsigned __int64 size)
{
    ...
    && ptr >= UFG::RigidBodyComponent::mAllocator.mBuffer )
  {
    *(_QWORD *)ptr = UFG::RigidBodyComponent::mAllocator.mFreeListHead;
    ...
    UFG::RigidBodyComponent::mAllocator.mFreeListHead = (char *)ptr;
  }
  else
  {
