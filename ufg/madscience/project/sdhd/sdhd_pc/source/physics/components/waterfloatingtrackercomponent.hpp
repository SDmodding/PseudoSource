...
UFG::ComponentIDDesc *__fastcall UFG::WaterFloatingTrackerComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::WaterFloatingTrackerComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::WaterFloatingTrackerComponent::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::WaterFloatingTrackerComponent::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::WaterFloatingTrackerComponent::_WaterFloatingTrackerComponentTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
