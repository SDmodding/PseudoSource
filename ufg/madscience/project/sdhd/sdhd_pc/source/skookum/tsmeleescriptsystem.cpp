...
void UFG::TSMeleeScriptSystem::BindAtomics(void)
{
  ...
  SSClass::register_method_func(v0, "get_active_gameslices", UFG::TSMeleeScriptSystem::Mthd_get_active_gameslices, 0);
  SSClass::register_method_func(v0, "get_spawn_group", UFG::TSMeleeScriptSystem::Mthd_get_spawn_group, 0);
  SSClass::register_method_func(v0, "get_start_trigger", UFG::TSMeleeScriptSystem::Mthd_get_start_trigger, 0);
}
...
void __fastcall UFG::TSMeleeScriptSystem::Mthd_get_active_gameslices(SSInvokedMethod *pScope, SSInstance **ppResult)
{
  ...
  if ( ppResult )
  {
    ...
    if ( v6 )
    {
      ...
      if ( (v8 >> 14) & 1 )
      {
        v7 = UFG::SimObjectGame::GetComponentOfTypeHK(v6, UFG::MeleeScriptSystemComponent::_TypeUID);
      }
      else if ( (v8 & 0x8000u) == 0 )
      {
        ...
        else
        {
          v7 = UFG::SimObject::GetComponentOfType(
                 ...
                 UFG::MeleeScriptSystemComponent::_TypeUID);
        }
      }
      else
      {
    ...
    v9 = UFG::qString::Tokenize((UFG::qString *)&v7[1].m_SafePointerList.mNode.mNext, &list, ";", 0i64);
...
void __fastcall UFG::TSMeleeScriptSystem::Mthd_get_spawn_group(SSInvokedMethod *pScope, SSInstance **ppResult)
{
  ...
  if ( ppResult )
  {
    ...
    if ( v6 )
    {
      ...
      if ( (v7 >> 14) & 1 )
      {
        v8 = UFG::SimObjectGame::GetComponentOfTypeHK(v6, UFG::MeleeScriptSystemComponent::_TypeUID);
      }
    ...
    v9 = (const char *)v5[2].m_SafePointerList.mNode.mNext;
    v10 = -1i64;
    do
      ++v10;
    while ( v9[v10] );
...
void __fastcall UFG::TSMeleeScriptSystem::Mthd_get_start_trigger(SSInvokedMethod *pScope, SSInstance **ppResult)
{
  ...
  if ( ppResult )
  {
    ...
    v9 = (const char *)v5[2].m_BoundComponentHandles.mNode.mNext;
    v10 = -1i64;
    do
      ++v10;
    while ( v9[v10] );
