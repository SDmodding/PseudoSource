...
UFG::ComponentIDDesc *__fastcall UFG::AudioEmitterMarker::AccessComponentDesc()
{
  ...
  if ( !UFG::AudioEmitterMarker::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::AudioEmitterMarker::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::AudioEmitterMarker::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::AudioEmitterMarker::_AudioEmitterMarkerTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
...
// File Line: 128
// RVA: 0x597590
bool __fastcall UFG::VehicleAudioComponent::ImpactEntity::CanApplyEnvironment(UFG::AudioEmitterMarker *this, UFG::qWiseSymbol *envType)
{
