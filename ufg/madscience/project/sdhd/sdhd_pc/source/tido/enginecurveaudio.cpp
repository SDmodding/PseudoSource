// File Line: 27
// RVA: 0x1555060
__int64 dynamic_initializer_for__EngAudioSym_gear_list__()
{
  unsigned int v0; // eax
...
// File Line: 28
// RVA: 0x1554FE0
__int64 dynamic_initializer_for__EngAudioSym_curve_list__()
{
  unsigned int v0; // eax
...
// File Line: 29
// RVA: 0x1555020
__int64 dynamic_initializer_for__EngAudioSym_curve_properties__()
{
  unsigned int v0; // eax
...
// File Line: 30
// RVA: 0x1555220
__int64 dynamic_initializer_for__EngAudioSym_point_index__()
{
  unsigned int v0; // eax
...
// File Line: 31
// RVA: 0x15552A0
__int64 dynamic_initializer_for__EngAudioSym_point_list_x__()
{
  unsigned int v0; // eax
...
// File Line: 32
// RVA: 0x15552E0
__int64 dynamic_initializer_for__EngAudioSym_point_list_y__()
{
  unsigned int v0; // eax
...
// File Line: 33
// RVA: 0x1555260
__int64 dynamic_initializer_for__EngAudioSym_point_list_properties__()
{
  unsigned int v0; // eax
...
// File Line: 34
// RVA: 0x15553E0
__int64 dynamic_initializer_for__EngAudioSym_x__()
{
  unsigned int v0; // eax
...
// File Line: 35
// RVA: 0x1555420
__int64 dynamic_initializer_for__EngAudioSym_y__()
{
  unsigned int v0; // eax
...
// File Line: 36
// RVA: 0x15551E0
__int64 dynamic_initializer_for__EngAudioSym_name__()
{
  unsigned int v0; // eax
...
// File Line: 37
// RVA: 0x15550A0
__int64 dynamic_initializer_for__EngAudioSym_id__()
{
  unsigned int v0; // eax
...
// File Line: 38
// RVA: 0x1555320
__int64 dynamic_initializer_for__EngAudioSym_type_decel__()
{
  unsigned int v0; // eax
...
// File Line: 39
// RVA: 0x15551A0
__int64 dynamic_initializer_for__EngAudioSym_minSpeed__()
{
  unsigned int v0; // eax
...
// File Line: 40
// RVA: 0x1555120
__int64 dynamic_initializer_for__EngAudioSym_maxSpeed__()
{
  unsigned int v0; // eax
...
// File Line: 41
// RVA: 0x1555160
__int64 dynamic_initializer_for__EngAudioSym_minRpm__()
{
  unsigned int v0; // eax
...
// File Line: 42
// RVA: 0x15550E0
__int64 dynamic_initializer_for__EngAudioSym_maxRpm__()
{
  unsigned int v0; // eax
...
// File Line: 43
// RVA: 0x1554FA0
__int64 dynamic_initializer_for__EngAudioSym_Gear0__()
{
  unsigned int v0; // eax
...
// File Line: 44
// RVA: 0x15553A0
__int64 dynamic_initializer_for__EngAudioSym_wwise_event__()
{
  unsigned int v0; // eax
...
// File Line: 45
// RVA: 0x1555360
__int64 dynamic_initializer_for__EngAudioSym_vehicle_event__()
{
  unsigned int v0; // eax
...
// File Line: 118
// RVA: 0x1559EA0
__int64 UFG::_dynamic_initializer_for__gsym_source_value__()
{
  unsigned int v0; // eax
...
// File Line: 119
// RVA: 0x1559EE0
__int64 UFG::_dynamic_initializer_for__gsym_target_value__()
{
  unsigned int v0; // eax
...
// File Line: 120
// RVA: 0x1559DE0
__int64 UFG::_dynamic_initializer_for__gsym_blend_mode__()
{
  unsigned int v0; // eax
...
// File Line: 121
// RVA: 0x1559E60
__int64 UFG::_dynamic_initializer_for__gsym_play_length__()
{
  unsigned int v0; // eax
...
// File Line: 122
// RVA: 0x1559E20
__int64 UFG::_dynamic_initializer_for__gsym_enable__()
{
  unsigned int v0; // eax
...
char __fastcall UFG::CreateFromPropertySet(UFG::AudioCurve *ac, UFG::qPropertySet *ps)
{
  ...
  char v25; // cl
  char v26; // r8
  UFG::AudioCurveSymbolManager *v27; // rax
  char v28; // cl
  char v29; // r8
  float *v30; // rax
  __int64 *v31; // rcx
  bool *v32; // rax
  __int64 *v33; // rcx
  UFG::qPropertyList *v34; // r14
  UFG::qPropertyList *v35; // r12
  __int64 v36; // rsi
  ...
  {
    v6 = UFG::qMemoryPool::Allocate(&g_AudioComponentPool, 0x400ui64, "AudioCurveSymbolManager", 0i64, 1u);
    v77 = v6;
    if ( v6 )
    {
      UFG::AudioCurveSymbolManager::AudioCurveSymbolManager((UFG::AudioCurveSymbolManager *)v6);
      v5 = v7;
    }
    else
    {
...
LABEL_29:
    ...
    v3->mSourceValue = v22;
    v24 = UFG::AudioCurveSymbolManager::GetInstance();
    if ( v18 == UFG::gNullQSymbol.mUID )
    {
      v25 = 0;
    }
    else
    {
      v25 = 1;
      v26 = v24->m_numSymbols;
      if ( v26 <= 1 )
        goto LABEL_37;
      while ( v24->m_symbols[v25].mUID != v18 )
      {
        if ( ++v25 >= v26 )
          goto LABEL_37;
      }
      ...
      {
LABEL_37:
        v25 = v24->m_numSymbols;
        v24->m_symbols[v26].mUID = v18;
        ++v24->m_numSymbols;
      }
    }
    v3->mTargetValue = v25;
    v27 = UFG::AudioCurveSymbolManager::GetInstance();
    if ( v20 == UFG::gNullQSymbol.mUID )
    {
      v28 = 0;
    }
    else
    {
      v28 = 1;
      v29 = v27->m_numSymbols;
      if ( v29 <= 1 )
        goto LABEL_45;
      while ( v27->m_symbols[v28].mUID != v20 )
      {
        if ( ++v28 >= v29 )
          goto LABEL_45;
      }
      ...
      {
LABEL_45:
        v28 = v27->m_numSymbols;
        v27->m_symbols[v29].mUID = v20;
        ++v27->m_numSymbols;
      }
    }
    v3->mBlendMode = v28;
  ...
  if ( (_DWORD)v36 )
  {
    ...
    do
    {
      *(float *)((char *)v45 + v46) = *UFG::qPropertyList::Get<float>(v34, v43);
      *v45 = *UFG::qPropertyList::Get<float>(v35, v43);
  ...
  if ( v48 )
  {
    ...
    else
    {
      ...
      if ( v53 + v54 > v56 )
      {
        ...
        if ( v57 - v55 > 0x10000 )
          v57 = v55 + 0x10000;
        UFG::qArray<UFG::AudioCurve::PointProperties,0>::Reallocate(v52, v57, "AudioCurve");
      }
      v52->size = v55;
    }
    v59 = 0;
...
void __fastcall UFG::EngineCurve::DestroyEngineCurve(UFG::EngineCurve *this)
{
  ...
  UFG::qNode<UFG::AudioCurveSet,UFG::AudioCurveSet> *v15; // rcx
  ...
  *(_QWORD *)&v1->m_gears.size = 0i64;
  for ( i = 0; i < v1->m_namedCurveSets.size; ++i )
  {
    ...
    if ( v12 )
    {
      ...
      if ( v13 )
        operator delete[](v13);
      v12->m_childCurveSets.p = 0i64;
      *(_QWORD *)&v12->m_childCurveSets.size = 0i64;
      v14 = v12->m_curves.p;
      if ( v14 )
        operator delete[](v14);
      v12->m_curves.p = 0i64;
      *(_QWORD *)&v12->m_curves.size = 0i64;
      v15 = v12->mPrev;
      v16 = v12->mNext;
      v15->mNext = v16;
      v16->mPrev = v15;
...
// File Line: 563
// RVA: 0x59D030
UFG::EngineManager *__fastcall UFG::EngineManager::GetInstance()
{
  UFG::EngineManager *result; // rax

  result = UFG::EngineManager::m_instance;
  if ( !UFG::EngineManager::m_instance )
  {
    result = (UFG::EngineManager *)UFG::qMemoryPool::Allocate(
                                     &g_AudioComponentPool,
                                     (unsigned int)((_DWORD)UFG::EngineManager::m_instance + 16),
                                     "EngineManager",
                                     0i64,
                                     1u);
    if ( result )
    {
      result->m_engineList.mNode.mPrev = &result->m_engineList.mNode;
      result->m_engineList.mNode.mNext = &result->m_engineList.mNode;
    }
    UFG::EngineManager::m_instance = result;
  }
  return result;
}
...
// File Line: 576
// RVA: 0x1559D60
__int64 UFG::_dynamic_initializer_for__gsymEngineManifest__()
{
  unsigned int v0; // eax
...
// File Line: 577
// RVA: 0x1559DA0
__int64 UFG::_dynamic_initializer_for__gsymEngines__()
{
  unsigned int v0; // eax
...
LABEL_5:
  ...
  if ( v6 )
  {
    ...
    v6[5].mNext = 0i64;
    v6[4].mNext = 0i64;
    LODWORD(v6[6].mNext) = UFG::gNullQSymbol;
    LODWORD(v6[7].mNext) = 0;
  }
  else
  {
    v4 = 0i64;
...
// File Line: 661
// RVA: 0x59C080
UFG::EngineManager *__fastcall UFG::EngineManager::FindEngine(UFG::EngineManager *this, UFG::qSymbol *engineName)
{
  UFG::EngineManager *result; // rax

  for ( result = (UFG::EngineManager *)this->m_engineList.mNode.mNext;
        result != this;
        result = (UFG::EngineManager *)result->m_engineList.mNode.mNext )
  {
    if ( result && LODWORD(result[3].m_engineList.mNode.mPrev) == engineName->mUID )
      return result;
  }
  return 0i64;
}
