...
UFG::ComponentIDDesc *__fastcall UFG::AICharacterControllerBaseComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::AICharacterControllerBaseComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::AICharacterControllerBaseComponent::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::AICharacterControllerBaseComponent::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::AICharacterControllerBaseComponent::_AICharacterControllerBaseComponentTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
...
UFG::ComponentIDDesc *__fastcall UFG::AICharacterControllerComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::AICharacterControllerComponent::_DescInit )
  {
    ...
    v1 = v0->mChildBitMask | (1 << SLOBYTE(UFG::CharacterControllerInterface::_TypeIDesc.mChildren));
    LOWORD(v3[0]) = v0->mBaseTypeIndex;
    *(_DWORD *)&UFG::AICharacterControllerComponent::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::AICharacterControllerComponent::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::AICharacterControllerComponent::_AICharacterControllerComponentTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
