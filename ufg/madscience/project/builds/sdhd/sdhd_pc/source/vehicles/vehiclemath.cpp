...
// File Line: 57
// RVA: 0x674650
float __fastcall UFG::ClosingTime(UFG::qVector3 *p0, UFG::qVector3 *v0, UFG::qVector3 *p1, UFG::qVector3 *v1, float *closing_speed)
{
  float v5; // xmm5_4
  __m128 v6; // xmm3
  float v7; // xmm7_4
  ...
  v6 = (__m128)LODWORD(v0->y);
  v8 = (__m128)LODWORD(p1->y);
  v5 = v0->x - v1->x;
  v6.m128_f32[0] = v6.m128_f32[0] - v1->y;
  v7 = p1->x - p0->x;
  v8.m128_f32[0] = v8.m128_f32[0] - p0->y;
  v9 = v0->z - v1->z;
  v10 = p1->z - p0->z;
  v11 = (float)((float)(v6.m128_f32[0] * v8.m128_f32[0]) + (float)(v5 * v7)) + (float)(v9 * v10);
  if ( closing_speed )
  {
    v8.m128_f32[0] = (float)((float)(v8.m128_f32[0] * v8.m128_f32[0]) + (float)(v7 * v7)) + (float)(v10 * v10);
    LODWORD(v12) = (unsigned __int128)_mm_sqrt_ps(v8);
    ...
    {
      v13 = v6;
      v13.m128_f32[0] = (float)((float)(v6.m128_f32[0] * v6.m128_f32[0]) + (float)(v5 * v5)) + (float)(v9 * v9);
      v14 = (unsigned __int128)_mm_sqrt_ps(v13);
    }
    *(_DWORD *)closing_speed = v14;
  }
  v15 = (float)((float)(v6.m128_f32[0] * v6.m128_f32[0]) + (float)(v5 * v5)) + (float)(v9 * v9);
...
// File Line: 77
// RVA: 0x68C060
float __fastcall UFG::SoonestCloserThan(UFG::qVector3 *p0, UFG::qVector3 *v0, UFG::qVector3 *p1, UFG::qVector3 *v1, float distance, float *closing_speed)
{
  float v6; // xmm2_4
  float v7; // xmm3_4
  float v8; // xmm4_4
  ...
  v7 = v1->x - v0->x;
  v8 = p1->z - p0->z;
  v12 = (__m128)LODWORD(v1->y);
  v10 = (__m128)LODWORD(p1->y);
  v12.m128_f32[0] = v12.m128_f32[0] - v0->y;
  v10.m128_f32[0] = v10.m128_f32[0] - p0->y;
  v9 = p1->x - p0->x;
  v11 = v12;
  v11.m128_f32[0] = v12.m128_f32[0] * v12.m128_f32[0];
  ...
  v12.m128_f32[0] = (float)((float)(v12.m128_f32[0] + (float)(v7 * v9)) + (float)(v6 * v8)) * 2.0;
  v13 = v10.m128_f32[0] - (float)(distance * distance);
  if ( closing_speed )
  {
    v14 = COERCE_FLOAT(_mm_sqrt_ps(v10)) * 2.0;
    if ( v14 >= 0.00000011920929 )
      v15 = v12.m128_f32[0] / v14;
    else
      LODWORD(v15) = (unsigned __int128)_mm_sqrt_ps(v11);
    *closing_speed = v15;
  }
  v16 = 0.0;
  if ( v13 >= 0.0 )
  {
    v17 = v12;
    v17.m128_f32[0] = (float)(v12.m128_f32[0] * v12.m128_f32[0]) - (float)((float)(v11.m128_f32[0] * 4.0) * v13);
    if ( v17.m128_f32[0] >= 0.0 )
    {
      v18 = v11.m128_f32[0] * 2.0;
      v19 = COERCE_FLOAT(v12.m128_i32[0] ^ _xmm[0]) - COERCE_FLOAT(_mm_sqrt_ps(v17));
