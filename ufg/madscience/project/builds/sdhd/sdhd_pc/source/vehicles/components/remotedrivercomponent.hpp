...
UFG::ComponentIDDesc *__fastcall UFG::RemoteDriverComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::RemoteDriverComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::RemoteDriverComponent::_TypeIDesc.mBaseTypeIndex = v3;
    ...
    UFG::RemoteDriverComponent::_TypeUID = v1 | ((unsigned __int16)v3 << 25);
    UFG::RemoteDriverComponent::_RemoteDriverComponentTypeUID = v1 | ((unsigned __int16)v3 << 25);
  }
