...
UFG::ComponentIDDesc *__fastcall UFG::BoatPhysicsMoverComponent::AccessComponentDesc()
{
  ...
  if ( !UFG::BoatPhysicsMoverComponent::_DescInit )
  {
    ...
    *(_DWORD *)&UFG::BoatPhysicsMoverComponent::_TypeIDesc.mBaseTypeIndex = v3[0];
    ...
    UFG::BoatPhysicsMoverComponent::_TypeUID = v1 | (LOWORD(v3[0]) << 25);
    UFG::BoatPhysicsMoverComponent::_BoatPhysicsMoverComponentTypeUID = v1 | (LOWORD(v3[0]) << 25);
  }
