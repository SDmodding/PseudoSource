...
__int64 dynamic_initializer_for__VehAudSym_Global__()
{
  ...
  return atexit((int (__fastcall *)())dynamic_atexit_destructor_for__VehAudSym_Global__);
}
...
__int64 dynamic_initializer_for__veh_common_ai__()
{
  ...
  return atexit((int (__fastcall *)())dynamic_atexit_destructor_for__veh_common_ai__);
}
