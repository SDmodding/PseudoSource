// File Line: 90
// RVA: 0xD09EE0
void __fastcall hkcdHelperEdgeDots(hkVector4f *vA, hkVector4f *vB, hkFourTransposedPointsf *vI, hkVector4f *vN, hkVector4f *vDotsOut)
{
  __m128 v5; // xmm1
  __m128 v6; // xmm3
  __m128 v7; // xmm5
  ...
  v5 = vA->m_quad;
  v6 = vN->m_quad;
  v7 = _mm_sub_ps(vI->m_vertices[0].m_quad, _mm_shuffle_ps(v5, v5, 0));
  v8 = _mm_shuffle_ps(v6, v6, 85);
  v9 = _mm_sub_ps(vI->m_vertices[1].m_quad, _mm_shuffle_ps(vA->m_quad, vA->m_quad, 85));
  v10 = _mm_sub_ps(vI->m_vertices[2].m_quad, _mm_shuffle_ps(v5, v5, 170));
