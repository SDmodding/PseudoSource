...
// File Line: 81
// RVA: 0xC8F070
void __fastcall cleanupLoadedObjecthkcdStaticTreeDynamicStorage4(void *p)
{
  int v1; // er8
  _DWORD *v2; // rbx
...
// File Line: 131
// RVA: 0xC8F0F0
void __fastcall cleanupLoadedObjecthkcdStaticTreeDynamicStorage5(void *p)
{
  int v1; // eax
  _DWORD *v2; // rbx
...
// File Line: 181
// RVA: 0xC8F170
void __fastcall cleanupLoadedObjecthkcdStaticTreeDynamicStorage6(void *p)
{
  int v1; // eax
  _DWORD *v2; // rbx
...
// File Line: 231
// RVA: 0xC8F1F0
void __fastcall cleanupLoadedObjecthkcdStaticTreeDynamicStorage32(void *p)
{
  int v1; // er8
  _DWORD *v2; // rbx
...
// File Line: 282
// RVA: 0xC8F270
void __fastcall cleanupLoadedObjecthkcdStaticTreeDynamicStoragehkcdStaticTreeCodec3Axis4(void *p)
{
  int v1; // er8
  _DWORD *v2; // rbx
...
// File Line: 333
// RVA: 0xC8F2F0
void __fastcall cleanupLoadedObjecthkcdStaticTreeDynamicStoragehkcdStaticTreeCodec3Axis5(void *p)
{
  int v1; // eax
  _DWORD *v2; // rbx
...
// File Line: 384
// RVA: 0xC8F370
void __fastcall cleanupLoadedObjecthkcdStaticTreeDynamicStoragehkcdStaticTreeCodec3Axis6(void *p)
{
  int v1; // eax
  _DWORD *v2; // rbx
...
// File Line: 435
// RVA: 0xC8F3F0
void __fastcall cleanupLoadedObjecthkcdStaticTreeDynamicStoragehkcdStaticTreeCodecRaw(void *p)
{
  int v1; // er8
  _DWORD *v2; // rbx
