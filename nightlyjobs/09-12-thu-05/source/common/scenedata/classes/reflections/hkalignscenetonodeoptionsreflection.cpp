...
// File Line: 70
// RVA: 0xE31640
void __fastcall finishLoadedObjecthkAlignSceneToNodeOptions(void *p, int finishing)
{
  JUMPOUT(p, 0i64, hkAlignSceneToNodeOptions::hkAlignSceneToNodeOptions);
}

// File Line: 76
// RVA: 0xE31660
void __fastcall cleanupLoadedObjecthkAlignSceneToNodeOptions(void *p)
{
...
{
  hkAlignSceneToNodeOptions v1; // [rsp+20h] [rbp-38h]
...
hkBaseObjectVtbl *dynamic_initializer_for__hkAlignSceneToNodeOptionsTypeInfo__()
{
  ...
  hkAlignSceneToNodeOptionsTypeInfo.m_finishLoadedObjectFunction = finishLoadedObjecthkAlignSceneToNodeOptions;
  hkAlignSceneToNodeOptionsTypeInfo.m_cleanupLoadedObjectFunction = cleanupLoadedObjecthkAlignSceneToNodeOptions;
  return result;
}
