...
// File Line: 150
// RVA: 0xB7DB50
hkVector4fComparison *__fastcall hkVector4UtilInternal::intersectRayBundle(
        hkVector4fComparison *result,
        hkAabb *aabb,
        hkFourTransposedPointsf *rayOrg,
        hkFourTransposedPointsf *rayInvDir,
        hkVector4f *maxFraction)
{
  hkVector4f v5; // xmm6
  ...
  v11 = _mm_mul_ps(
          ...
          rayInvDir->m_vertices[0].m_quad);
  v12 = _mm_shuffle_ps(v5.m_quad, v5.m_quad, 85);
  v13 = _mm_mul_ps(
  ...
  result->m_mask = _mm_cmple_ps(
                     _mm_max_ps(
                       _mm_max_ps(_mm_max_ps(_mm_min_ps(v8, v11), _mm_min_ps(v10, v14)), _mm_min_ps(v9, v13)),
                       (__m128)0i64),
                     _mm_min_ps(
                       maxFraction->m_quad,
                       _mm_min_ps(_mm_min_ps(_mm_max_ps(v8, v11), _mm_max_ps(v10, v14)), _mm_max_ps(v9, v13))));
  return v6;
}
