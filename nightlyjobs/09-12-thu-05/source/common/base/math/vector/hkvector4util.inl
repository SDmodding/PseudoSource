// File Line: 1928
// RVA: 0xD16B50
void __usercall hkVector4UtilImpl<float>::getFloatToInt16FloorCorrection(float *out@<rcx>, __m128i a2@<xmm0>)
{
  float v2; // xmm4_4
  __int128 v3; // xmm2
  ...
  do
  {
    ...
    *(float *)&v7 = (float)(*(float *)&v3 + v2) * 0.5;
    a2.m128i_i32[0] = v7;
    v8 = _mm_mul_ps(_mm_add_ps(_mm_shuffle_ps((__m128)a2, (__m128)a2, 0), aabbOut.m_quad), query.m_quad);
    v9 = (__m128i)_mm_cmpleps(*(__m128 *)`hkIntVector::setConvertF32toS32::`2::two31, v8);
    a2 = _mm_cvttps_epi32(v8);
    v10 = _mm_sub_epi32(_mm_xor_si128(v9, a2), v5);
    if ( (unsigned __int16)*(_OWORD *)&_mm_add_epi16(_mm_packs_epi32(v10, v10), v6) >= 0xBu )
      v3 = v7;
    else
...
__int64 __fastcall hkVector4UtilImpl<float>::packQuaternionIntoInt32(hkVector4f *qin)
{
  ...
  v2 = _mm_and_si128(
         _mm_add_epi32(
           _mm_xor_si128(
             (__m128i)_mm_cmpleps(*(__m128 *)`hkIntVector::setConvertF32toS32::`2::two31, v1),
             _mm_cvttps_epi32(v1)),
           (__m128i)_xmm),
         (__m128i)_xmm);
