...
void __fastcall hkPackedVector3::pack(hkPackedVector3 *this, hkVector4d *vIn)
{
  ...
  __m128i v11; // [rsp+10h] [rbp-18h] BYREF
  ...
  *(float *)&v10.m128i_i32[2] = *(float *)&v11.m128i_i32[2] * 1.0000153;
  v5 = (__m128)_mm_and_si128(_mm_load_si128(&v10), *(__m128i *)mask_2);
  v10 = (__m128i)v5;
  v6 = _mm_shuffle_ps(v5, v5, 85);
...
void __fastcall hkPackedVector8_3::pack(hkPackedVector8_3 *this, hkVector4d *vIn)
{
  ...
  float v12; // xmm1_4
  __m128i v13; // xmm3
  int v14; // [rsp+20h] [rbp+0h] BYREF

  v2 = (unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64;
  v3 = _mm_cvtpd_ps(vIn->m_quad.xy);
  v4 = _mm_cvtpd_ps(vIn->m_quad.zw);
  *(_DWORD *)v2 = 1065385984;
  v5 = (__m128i)_mm_movelh_ps(v3, v4);
  v6 = *(float *)((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64);
  *(float *)(v2 + 32) = *(float *)v5.m128i_i32 * *(float *)v2;
  *(_DWORD *)(v2 + 32) &= 0x7F800000u;
  *(float *)(v2 + 36) = _mm_shuffle_ps((__m128)v5, (__m128)v5, 85).m128_f32[0] * v6;
  v7 = *(_DWORD *)(((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64) + 0x20);
  *(_DWORD *)(v2 + 36) &= 0x7F800000u;
  v4.m128_f32[0] = _mm_shuffle_ps((__m128)v5, (__m128)v5, 170).m128_f32[0] * v6;
  *(_DWORD *)v2 = v7;
  v8 = *(float *)((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64);
  *(_DWORD *)(v2 + 40) = v4.m128_i32[0];
  v4.m128_i32[0] = *(_DWORD *)(((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64) + 0x24);
  *(_DWORD *)(v2 + 40) &= 0x7F800000u;
  *(_DWORD *)(v2 + 8) = v4.m128_i32[0];
  v9 = fmaxf(v8, *(float *)(((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64) + 8));
  *(_DWORD *)(v2 + 8) = *(_DWORD *)(v2 + 40);
  *(float *)v2 = v9;
  v10 = *(float *)(((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64) + 8);
  *(float *)(v2 + 8) = FLOAT_1_4210855eN14;
  *(float *)v2 = fmaxf(v10, *(float *)((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64));
  *(float *)(v2 + 8) = fmaxf(
                         *(float *)(((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64) + 8),
                         *(float *)((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64));
  v11 = 1317011456 - *(_DWORD *)(((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64) + 8);
  *(_DWORD *)(v2 + 32) = v11 + _mm_cvtsi128_si32(v5);
  *(_DWORD *)(v2 + 8) = *(_DWORD *)(v2 + 32);
  *(_DWORD *)(v2 + 36) = v11 + _mm_cvtsi128_si32(_mm_srli_si128(v5, 4));
  *(_DWORD *)v2 = *(_DWORD *)(v2 + 36);
  v4.m128_i32[0] = *(_DWORD *)(((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64) + 8);
  v12 = *(float *)((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64);
  *(_DWORD *)(v2 + 16) = v11 + _mm_cvtsi128_si32(_mm_srli_si128(v5, 8));
  v13 = _mm_add_epi32(
          _mm_unpacklo_epi32(
            _mm_unpacklo_epi32(
              _mm_cvtsi32_si128((int)v4.m128_f32[0]),
              _mm_cvtsi32_si128((int)*(float *)(((unsigned __int64)&v14 & 0xFFFFFFFFFFFFFFE0ui64) + 0x10))),
            _mm_unpacklo_epi32(_mm_cvtsi32_si128((int)v12), _mm_cvtsi32_si128(v11))),
          *(__m128i *)roundingCorrection_0);
  this->m_values[0] = _mm_cvtsi128_si32(_mm_srli_si128(v13, 3));
  this->m_values[1] = _mm_cvtsi128_si32(_mm_srli_si128(v13, 7));
  this->m_values[2] = _mm_cvtsi128_si32(_mm_srli_si128(v13, 11));
  this->m_values[3] = (16256 - _mm_extract_epi16(_mm_shuffle_epi32(_mm_cvtsi32_si128(v11), 0), 1)) >> 7;
}
