// File Line: 13
// RVA: 0x12FE960
void __fastcall hkSweptTransformf::approxTransformAt(hkSweptTransformf *this, hkSimdFloat32 *time, hkTransformf *transformOut)
{
  hkSweptTransformf *v3; // rbx
  hkTransformf *v4; // rdi
  __m128 v5; // xmm6
  __m128 v6; // xmm3
  __m128 v7; // xmm0
  ...
  __m128 v11; // xmm3
  __m128 v12; // xmm1
  hkQuaternionf qi; // [rsp+20h] [rbp-28h]
  ...
  v11 = _mm_add_ps(
          _mm_mul_ps(_mm_sub_ps(v3->m_centerOfMass1.m_quad, v3->m_centerOfMass0.m_quad), v5),
          v3->m_centerOfMass0.m_quad);
  v4->m_translation.m_quad = v11;
  v12 = v3->m_centerOfMassLocal.m_quad;
  v4->m_translation.m_quad = _mm_sub_ps(
                               v11,
                               _mm_add_ps(
                                 _mm_add_ps(
                                   _mm_mul_ps(_mm_shuffle_ps(v12, v12, 85), v4->m_rotation.m_col1.m_quad),
...
// File Line: 55
// RVA: 0x12FEA50
void __fastcall hkSweptTransformf::initSweptTransform(hkSweptTransformf *this, hkVector4f *position, hkQuaternionf *rotation)
{
  __m128 v3; // xmm1
  ...
  v3 = rotation->m_vec.m_quad;
  this->m_centerOfMassLocal = 0i64;
  this->m_rotation1.m_vec.m_quad = v3;
}
