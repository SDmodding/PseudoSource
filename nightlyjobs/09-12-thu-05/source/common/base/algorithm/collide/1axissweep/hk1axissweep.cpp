// File Line: 171
// RVA: 0xC67D70
signed __int64 __fastcall hk1AxisSweep::collide(hk1AxisSweep::AabbInt *pa, int numA, hk1AxisSweep::AabbInt *pb, int numB, hkKeyPair *pairsOut, int maxNumPairs, hkPadSpu<int> *numPairsSkipped)
{
  hkKeyPair *v7; // rbx
  int v8; // er11
  hkKeyPair *v9; // rax
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( v12 <= v15 )
      {
        ...
        do
        {
          ...
          v20 = *(v11 - 1);
          v21 = ((*(v11 - 1) - *v16) | (v16[5] - v18) | (v16[4] - v17) | (*v11 - v16[1])) & 0x80000000;
    ...
    if ( v13 <= v25 )
    {
      ...
      do
      {
        ...
        v30 = *(v10 - 1);
        v31 = ((*(v10 - 1) - *v26) | (v26[5] - v28) | (v26[4] - v27) | (*v10 - v26[1])) & 0x80000000;
...
// File Line: 207
// RVA: 0xC68140
void __fastcall hk1AxisSweep::collide(hk1AxisSweep::AabbInt *pa, int numA, hk1AxisSweep::AabbInt *pb, int numB, hkArray<hkKeyPair,hkContainerHeapAllocator> *pairsOut)
{
  int v5; // er10
  unsigned int *v6; // r14
  unsigned int *v7; // r15
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( v8 <= v11 )
      {
        ...
        do
        {
          ...
          v16 = *(v7 - 1);
          v17 = ((*(v7 - 1) - *v12) | (v12[5] - v14) | (v12[4] - v13) | (*v7 - v12[1])) & 0x80000000;
          ...
          if ( !(v17 & v18 & v19 & v15) )
          {
            if ( !v15 )
            {
              if ( pairsOut->m_size == (pairsOut->m_capacityAndFlags & 0x3FFFFFFF) )
                hkArrayUtil::_reserveMore((hkMemoryAllocator *)&hkContainerHeapAllocator::s_alloc.vfptr, pairsOut, 8);
              v20 = pairsOut->m_size;
              v21 = &pairsOut->m_data[v20];
              pairsOut->m_size = v20 + 1;
              v21->m_keyA = *(v12 - 6);
              v21->m_keyB = *(v7 - 3);
            }
            if ( !v17 && *(v12 - 1) <= v11 )
    ...
    if ( v9 <= v29 )
    {
      ...
      do
      {
        ...
        v34 = v6[4];
        v35 = ((v6[3] - *v30) | (v30[4] - v32) | (v30[5] - *v6) | (v6[4] - v30[1])) & 0x80000000;
        v36 = ((v30[12] - v32) | (v30[13] - *v6) | (v34 - v30[9]) | (v6[3] - v30[8])) & 0x80000000;
...
// File Line: 236
// RVA: 0xC68620
signed __int64 __fastcall hk1AxisSweep::collide(hk1AxisSweep::AabbInt *pa, int numA, hkKeyPair *pairsOut, int maxNumPairs, hkPadSpu<int> *numPairsSkipped)
{
  int v5; // er13
  hkKeyPair *v6; // rsi
  hkKeyPair *v7; // rax
    ...
    do
    {
      ...
      if ( v8[2] <= v9 )
      {
        ...
        do
        {
          ...
          v15 = ((*(v8 - 1) - *v10) | (v10[4] - v13) | (v10[5] - v12) | (*v8 - v10[1])) & 0x80000000;
          v16 = ((v10[12] - v13) | (v10[13] - v12) | (*v8 - v10[9]) | (*(v8 - 1) - v10[8])) & 0x80000000;
...
// File Line: 260
// RVA: 0xC68830
void __fastcall hk1AxisSweep::collide(hk1AxisSweep::AabbInt *pa, int numA, hkArray<hkKeyPair,hkContainerHeapAllocator> *pairsOut)
{
  int v3; // er13
  hkArray<hkKeyPair,hkContainerHeapAllocator> *v4; // rbx
  unsigned int *v5; // rsi
  unsigned int v6; // ebp
  _DWORD *v7; // rdi
  int v8; // ecx
    ...
    do
    {
      ...
      if ( v5[2] <= v6 )
      {
        ...
        do
        {
          ...
          v11 = *(v5 - 1);
          v12 = ((*(v5 - 1) - *v7) | (v7[5] - v9) | (v7[4] - v8) | (*v5 - v7[1])) & 0x80000000;
...
// File Line: 276
// RVA: 0xC68AC0
void __fastcall hk1AxisSweep::sortAabbs(hk1AxisSweep::AabbInt *aabbs, int size)
{
  int v2; // er13
  int v3; // esi
  hk1AxisSweep::AabbInt *v4; // r12
  int v5; // ebx
  unsigned int v6; // eax
  ...
  {
    v29 = 32 * v2;
    v18 = (_BYTE *)hkContainerTempAllocator::s_alloc.vfptr->bufAlloc(
                     (hkMemoryAllocator *)&hkContainerTempAllocator::s_alloc,
                     &v29);
    v17 = v29 / 32;
  }
  ...
  if ( 2 * v2 > 0 )
  {
    ...
    do
    {
      v26 = *(unsigned int *)((char *)v16 + v25);
      v27 = *(unsigned int *)((char *)v16 + v25 + 4);
      v28 = *(unsigned int *)((char *)v16 + v25 - 8);
      ++v3;
      *(v16 - 1) = *(unsigned int *)((char *)v16 + v25 - 4);
      *v16 = v26;
      v16[1] = v27;
      *(v16 - 2) = v28;
      v16 += 4;
  ...
  if ( v8 >= 0 )
    ((void (__fastcall *)(hkContainerTempAllocator::Allocator *, hkRadixSort::SortData32 *, _QWORD, unsigned int *))hkContainerTempAllocator::s_alloc.vfptr->bufFree)(
      ...
      (unsigned int)(8 * v8),
      v16);
}ed int *))hkContainerTempAllocator::s_alloc.vfptr->bufFree)(
      &hkContai

// File Line: 312
// RVA: 0xC68D20
void __fastcall hk1AxisSweep::sortAabbs(hk1AxisSweep::AabbInt *aabbs, int size, hkArrayBase<hkRadixSort::SortData32> *sortArray, hkArrayBase<hk1AxisSweep::AabbInt> *sortedAabbs)
{
  signed int v4; // ebx
  __int64 v5; // r15
  hkRadixSort::SortData32 **v6; // r14
  hkArrayBase<hkRadixSort::SortData32> *v7; // rsi
  hk1AxisSweep::AabbInt *v8; // rbp
  int v9; // edx
  ...
  hkRadixSort::SortData32 *v20; // r8
  hkRadixSort::SortData32 *v21; // r10
  ...
  v4 = 0;
  v5 = size;
  v6 = (hkRadixSort::SortData32 **)sortedAabbs;
  v7 = sortArray;
  v8 = aabbs;
  ...
  hkRadixSort::sort32(sortArray->m_data, v9, *v6);
  if ( (signed int)v5 > 0 )
  {
    v15 = 0i64;
    v16 = 0i64;
    ...
    {
      v18 = 2;
      v19 = &v8[v7->m_data[v15].m_userData];
      v20 = &(*v6)[v16];
      do
      {
        --v18;
        v20 += 2;
        *(_OWORD *)&v20[-2].m_key = *(_OWORD *)v19->m_min;
  ...
  v21 = *v6;
  v22 = 2 * v5 & 0xFFFFFFFFFFFFFFFi64;
  if ( 2 * (signed int)v5 > 0 )
  {
    v23 = &v8->m_min[2];
    do
    {
      v24 = v21[1].m_key;
      v25 = v21[1].m_userData;
      v26 = v21->m_key;
      ++v4;
      *(v23 - 1) = v21->m_userData;
      *v23 = v24;
      v23[1] = v25;
      *(v23 - 2) = v26;
      v23 += 4;
    ...
    while ( v4 < (signed int)v22 );
  }
}

// File Line: 368
// RVA: 0xC67D10
void __fastcall hk1AxisSweep::AabbInt::set(hk1AxisSweep::AabbInt *this, hkAabb *aabbIn, int key)
{
  __m128i v3; // xmm3
  ...
  v3 = _mm_add_epi32(
         _mm_srli_epi32(
           _mm_xor_si128(
             _mm_or_si128(
               _mm_srai_epi32(_mm_load_si128((const __m128i *)&aabbIn->m_max), 0x1Fu),
               *(__m128i *)simdSignBit),
             (__m128i)aabbIn->m_max.m_quad),
           1u),
         *(__m128i *)simdOne);
  _mm_store_si128(
    (__m128i *)this,
    _mm_insert_epi16(
      _mm_insert_epi16(
        _mm_srli_epi32(
          _mm_xor_si128(
            _mm_or_si128(_mm_srai_epi32(_mm_load_si128((const __m128i *)aabbIn), 0x1Fu), *(__m128i *)simdSignBit),
            (__m128i)aabbIn->m_min.m_quad),
          1u),
        key,
        6),
      (unsigned int)key >> 16,
      7));
  _mm_store_si128((__m128i *)this->m_max, v3);
}
