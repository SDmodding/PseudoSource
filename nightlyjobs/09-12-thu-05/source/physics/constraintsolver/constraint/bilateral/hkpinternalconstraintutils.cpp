// File Line: 15
// RVA: 0xD4E480
void __fastcall hkInternalConstraintUtils_calcRelativeAngle(
        hkVector4f *twistAxisAinWorld,
        hkVector4f *twistAxisBinWorld,
        hkVector4f *planeAxisAinWorld,
        hkVector4f *planeAxisBinWorld,
        hkVector4f *axisOut,
        hkPadSpu<float> *angleOut)
{
  __m128 v6; // xmm8
  __m128 v7; // xmm1
  __m128 v8; // xmm3
  ...
  {
    m_quad = twistAxisBinWorld->m_quad;
  }
  else
  {
    v11 = _mm_rcp_ps(v10);
    m_quad = _mm_mul_ps(v6, _mm_mul_ps(_mm_sub_ps((__m128)_xmm, _mm_mul_ps(v11, v10)), v11));
  }
  v13 = _mm_shuffle_ps(m_quad, m_quad, 201);
  v14 = _mm_sub_ps(
          _mm_mul_ps(_mm_shuffle_ps(planeAxisBinWorld->m_quad, planeAxisBinWorld->m_quad, 201), m_quad),
          _mm_mul_ps(planeAxisBinWorld->m_quad, v13));
  v15 = _mm_shuffle_ps(v14, v14, 201);
  v16 = _mm_mul_ps(planeAxisAinWorld->m_quad, v15);
  v17 = _mm_sub_ps(_mm_mul_ps(v13, v15), _mm_mul_ps(_mm_shuffle_ps(v15, v15, 201), m_quad));
  ...
  v26 = _mm_cmple_ps((__m128)0i64, v20);
  v27 = _mm_or_ps(
          _mm_and_ps(_mm_sub_ps(_mm_or_ps(_mm_and_ps(v23, *(__m128 *)_xmm), *(__m128 *)_xmm), v25), v22),
          _mm_andnot_ps(v22, v25));
  LODWORD(angleOut->m_storage) = _mm_andnot_ps(
                                   v26,
                                   _mm_add_ps(_mm_or_ps(_mm_and_ps(v18, *(__m128 *)_xmm), *(__m128 *)_xmm), v27)).m128_u32[0] | v27.m128_i32[0] & v26.m128_i32[0];
  *axisOut = (hkVector4f)m_quad;
}
