// File Line: 16
// RVA: 0xD77290
void __fastcall hkpKeyframedRigidMotion::hkpKeyframedRigidMotion(
        hkpKeyframedRigidMotion *this,
        hkVector4f *position,
        hkQuaternionf *rotation)
{
  ...
  this->m_inertiaAndMassInv = 0i64;
  this->m_savedMotion = 0i64;
  this->m_savedQualityTypeIndex = 0;
}
...
{
  hkpMaxSizeMotion *m_savedMotion; // rcx

  this->vfptr = (hkBaseObjectVtbl *)&hkpKeyframedRigidMotion::`vftable;
  m_savedMotion = this->m_savedMotion;
  if ( m_savedMotion )
...
// File Line: 99
// RVA: 0xD77510
void __fastcall hkpKeyframedRigidMotion::applyPointImpulse(
        hkpKeyframedRigidMotion *this,
        hkVector4f *imp,
        hkVector4f *p)
{
...
// File Line: 107
// RVA: 0xD77530
void __fastcall hkpKeyframedRigidMotion::applyForce(
        hkpKeyframedRigidMotion *this,
...
// File Line: 115
// RVA: 0xD77550
void __fastcall hkpKeyframedRigidMotion::applyTorque(
        hkpKeyframedRigidMotion *this,
        const float deltaTime,
        hkVector4f *torque)
{
...
void __fastcall hkpKeyframedRigidMotion::setStoredMotion(hkpKeyframedRigidMotion *this, hkpMaxSizeMotion *savedMotion)
{
  ...
  if ( savedMotion )
    hkReferencedObject::addReference(savedMotion);
  m_savedMotion = this->m_savedMotion;
  if ( m_savedMotion )
    hkReferencedObject::removeReference(m_savedMotion);
  this->m_savedMotion = savedMotion;
}

// File Line: 136
// RVA: 0xD77400
void __fastcall hkpKeyframedRigidMotion::getProjectedPointVelocity(
        hkpKeyframedRigidMotion *this,
        hkVector4f *pos,
        hkVector4f *normal,
        float *velOut,
...
// File Line: 147
// RVA: 0xD77480
void __fastcall hkpKeyframedRigidMotion::getProjectedPointVelocitySimd(
        hkpKeyframedRigidMotion *this,
        hkVector4f *pos,
        hkVector4f *normal,
