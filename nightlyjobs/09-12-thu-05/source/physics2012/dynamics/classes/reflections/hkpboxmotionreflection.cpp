...
// File Line: 58
// RVA: 0xD500C0
void __fastcall finishLoadedObjecthkpBoxMotion(_WORD *p, int finishing)
{
  if ( p )
  {
...
// File Line: 64
// RVA: 0xD50100
void __fastcall cleanupLoadedObjecthkpBoxMotion(void (__fastcall ***p)(_QWORD, _QWORD))
{
  (**p)(p, 0i64);
}
...
void **dynamic_initializer_for__hkpBoxMotionTypeInfo__()
{
  ...
  hkpBoxMotionTypeInfo.m_finishLoadedObjectFunction = (void (__fastcall *)(void *, int))finishLoadedObjecthkpBoxMotion;
  hkpBoxMotionTypeInfo.m_cleanupLoadedObjectFunction = (void (__fastcall *)(void *))cleanupLoadedObjecthkpBoxMotion;
  return result;
}
