// File Line: 24
// RVA: 0xD7D5F0
void __fastcall hkpEntityEntityBroadPhaseListener::hkpEntityEntityBroadPhaseListener(hkpEntityEntityBroadPhaseListener *this, hkpWorld *world)
{
...
// File Line: 29
// RVA: 0xD7D620
void __fastcall hkpEntityEntityBroadPhaseListener::addCollisionPair(hkpEntityEntityBroadPhaseListener *this, hkpTypedBroadPhaseHandlePair *pair)
{
  ...
  if ( v5 )
  {
    v4->m_createPredictiveAgents.m_storage = v4->m_dispatcher.m_storage->m_collisionQualityInfo[(signed __int64)v5].m_useContinuousPhysics.m_storage;
...
// File Line: 64
// RVA: 0xD7D690
void __fastcall hkpEntityEntityBroadPhaseListener::removeCollisionPair(hkpEntityEntityBroadPhaseListener *this, hkpTypedBroadPhaseHandlePair *pair)
{
  hkpAgentNnEntry *v2; // rax

  v2 = hkAgentNnMachine_FindAgent(
         (hkpLinkedCollidable *)((char *)pair->m_a + SBYTE1(pair->m_a[1].m_id)),
         (hkpLinkedCollidable *)((char *)pair->m_b + SBYTE1(pair->m_b[1].m_id)));
  if ( v2 )
    hkpWorldAgentUtil::removeAgent(v2);
}
