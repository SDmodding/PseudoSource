// File Line: 26
// RVA: 0xB5B4D0
void __fastcall hkaiNavMeshEdgeMatchingParameters::hkaiNavMeshEdgeMatchingParameters(
        hkaiNavMeshEdgeMatchingParameters *this)
{
  ...
  v9 = _mm_mul_ps(v8, v8);
  LODWORD(this->m_cosPlanarAlignmentAngle) = (_mm_andnot_ps(
                                                v7,
                                                _mm_add_ps(
                                                  _mm_sub_ps(
                                                    _mm_mul_ps(
  ...
  LODWORD(this->m_cosVerticalAlignmentAngle) = (_mm_andnot_ps(
                                                  v16,
                                                  _mm_add_ps(
                                                    _mm_sub_ps(
                                                      _mm_mul_ps(
                                                        _mm_mul_ps(
                                                          _mm_add_ps(
                                                            _mm_mul_ps(
                                                              _mm_add_ps(
                                                                _mm_mul_ps(v18, *(__m128 *)cosCoeff0_0),
                                                                *(__m128 *)cosCoeff1),
                                                              v18),
                                                            *(__m128 *)cosCoeff2_0),
                                                          v18),
                                                    ...
                                                    *(__m128 *)_xmm)).m128_u32[0] | COERCE_UNSIGNED_INT(
                                                                                      (float)((float)((float)((float)((float)((float)(v18.m128_f32[0] * -0.00019515296) + 0.0083321612) * v18.m128_f32[0]) + -0.16666655) * v18.m128_f32[0])
                                                                                            * v17.m128_f32[0])
                                                                                    + v17.m128_f32[0]) & v16.m128_i32[0]) ^ (_mm_and_si128(_mm_add_epi32(v12, v12), v14).m128i_u32[0] << 29) ^ v10.m128_i32[0] & _xmm[0];
  ...
  LODWORD(this->m_cosClimbingFaceNormalAlignmentAngle) = (_mm_andnot_ps(
                                                            v24,
                                                            _mm_add_ps(
                                                              _mm_sub_ps(
                                                                _mm_mul_ps(
                                                              ...
                                                              *(__m128 *)_xmm)).m128_u32[0] | COERCE_UNSIGNED_INT(
                                                                                                (float)((float)((float)((float)((float)((float)(v27.m128_f32[0] * -0.00019515296) + 0.0083321612) * v27.m128_f32[0]) + -0.16666655) * v27.m128_f32[0]) * v26.m128_f32[0])
                                                                                              + v26.m128_f32[0]) & v24.m128_i32[0]) ^ (_mm_and_si128(_mm_add_epi32(v21, v21), v23).m128i_u32[0] << 29) ^ v19.m128_i32[0] & _xmm[0];
  ...
  LODWORD(this->m_cosClimbingEdgeAlignmentAngle) = (_mm_andnot_ps(
                                                      v34,
                                                      _mm_add_ps(
                                                        _mm_sub_ps(
                                                          _mm_mul_ps(
                                                            _mm_mul_ps(
                                                              _mm_add_ps(
                                                                _mm_mul_ps(
                                                                  _mm_add_ps(
                                                                    _mm_mul_ps(v36, *(__m128 *)cosCoeff0_0),
                                                                    *(__m128 *)cosCoeff1),
                                                                  v36),
                                                                *(__m128 *)cosCoeff2_0),
                                                              v36),
                                                        ...
                                                        *(__m128 *)_xmm)).m128_u32[0] | COERCE_UNSIGNED_INT(
                                                                                          (float)((float)((float)((float)((float)((float)(v36.m128_f32[0] * -0.00019515296) + 0.0083321612) * v36.m128_f32[0]) + -0.16666655) * v36.m128_f32[0])
                                                                                                * v35.m128_f32[0])
                                                                                        + v35.m128_f32[0]) & v34.m128_i32[0]) ^ (_mm_and_si128(_mm_add_epi32(v30, v30), v32).m128i_u32[0] << 29) ^ v29.m128_i32[0] & _xmm[0];
