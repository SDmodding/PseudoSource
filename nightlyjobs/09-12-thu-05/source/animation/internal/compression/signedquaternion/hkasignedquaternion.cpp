...
void __fastcall hkaSignedQuaternion::packSignedQuaternion16(hkQuaternionf *in, char *out)
{
  ...
  v3 = _mm_add_epi32(
         _mm_xor_si128(
           (__m128i)_mm_cmple_ps(*(__m128 *)`hkIntVector::setConvertF32toS32::`2::two31, v2),
           _mm_cvttps_epi32(v2)),
         (__m128i)_xmm);
  v4 = _mm_or_si128(
  ...
  v6 = _mm_packus_epi16(v5, v5).m128i_u32[0];
  *out = v6 | BYTE1(v6);
...
// File Line: 145
// RVA: 0xBAABC0
void __fastcall hkaSignedQuaternion::packSignedQuaternion24(const __m128i *in, char *out)
{
  __m128 v3; // xmm2
  __m128 v4; // xmm1
  int v5; // r9d
  ...
  __m128 v10; // xmm0
  __m128 v11; // xmm2
  __m128i v12; // [rsp+0h] [rbp-18h] BYREF

  v3 = (__m128)_mm_srli_epi32(_mm_slli_epi32(_mm_load_si128(in), 1u), 1u);
  ...
  v5 = (unsigned __int8)hkVector4Comparison_maskToLastIndex[_mm_movemask_ps(
                                                              _mm_cmple_ps(
                                                                ...
                                                                v3))];
  v6 = _mm_mul_ps(_mm_shuffle_ps((__m128)LODWORD(FLOAT_89_095451), (__m128)LODWORD(FLOAT_89_095451), 0), *(__m128 *)in);
  v7 = _mm_add_epi32(
         _mm_xor_si128(
  ...
  v12 = _mm_packus_epi16(v8, v8);
  *out = v12.m128i_i8[v5 == 0];
  v9 = ((v5 == 0) + 1 == v5) + (v5 == 0) + 1;
  out[1] = v12.m128i_i8[v9];
  LOBYTE(v9) = v12.m128i_i8[v9 + 1 + (v9 + 1 == v5)];
  out[2] = v9;
  v10 = _mm_and_ps((__m128)`hkVector4f::getComponent::`2::indexToMask[v5], *(__m128 *)in);
  *out |= (_BYTE)v5 << 7;
  out[1] |= (v5 & 0xFE) << 6;
  v11 = _mm_or_ps(_mm_shuffle_ps(v10, v10, 78), v10);
  out[2] = v9 | ((COERCE_FLOAT(_mm_shuffle_ps(v11, v11, 177).m128_u32[0] | v11.m128_i32[0]) < 0.0) << 7);
}

// File Line: 215
// RVA: 0xBAACF0
void __fastcall hkaSignedQuaternion::packSignedQuaternion32(const __m128i *in, char *out8)
{
  int v3; // r9d
  __m128 v4; // xmm10
  __m128 v5; // xmm1
  ...
  if ( (_mm_movemask_ps(_mm_cmpeq_ps((__m128)0i64, *(__m128 *)in)) & 7) == 7 )
  {
    *(_DWORD *)out8 = 0;
  }
  else
  {
    v3 = _mm_movemask_ps(_mm_cmplt_ps(*(__m128 *)in, (__m128)0i64)) << 28;
    *(_DWORD *)out8 = v3;
    v4 = (__m128)_mm_srli_epi32(_mm_slli_epi32(_mm_load_si128(in), 1u), 1u);
    v5 = _mm_mul_ps(v4, v4);
    ...
    v20 = _mm_add_ps(
            _mm_mul_ps(
              ...
              v17),
            v17);
    v20.m128_i32[0] = (_mm_andnot_ps(
                         v14,
                         _mm_or_ps(
                           _mm_and_ps(_mm_sub_ps(*(__m128 *)_xmm, _mm_add_ps(v20, v20)), v16),
                           _mm_andnot_ps(v16, v20))).m128_u32[0] | v14.m128_i32[0] & v13.m128_i32[0]) ^ v12.m128_i32[0] & _xmm[0];
    ...
    v29 = _mm_cmple_ps((__m128)0i64, v22);
    v30 = _mm_or_ps(
            _mm_andnot_ps(v29, _mm_add_ps(_mm_or_ps(_mm_and_ps(v19, *(__m128 *)_xmm), *(__m128 *)_xmm), v28)),
            _mm_and_ps(v28, v29));
    if ( (_mm_movemask_ps(_mm_cmpeq_ps(v10, (__m128)0i64)) & 3) == 3 )
      v30 = 0i64;
    v31 = 0i64;
    ...
    *(_DWORD *)out8 = v33 | (_mm_cvtsi128_si32(
                               _mm_cvttps_epi32(
                                 _mm_add_ps(
                                   _mm_mul_ps(
                                     _mm_shuffle_ps((__m128)LODWORD(FLOAT_1023_0), (__m128)LODWORD(FLOAT_1023_0), 0),
                                     _mm_andnot_ps(_mm_cmple_ps(v34, (__m128)0i64), _mm_mul_ps(_mm_rsqrt_ps(v34), v34))),
...
// File Line: 328
// RVA: 0xBAB0F0
void __fastcall hkaSignedQuaternion::packSignedQuaternion40(const __m128i *in, char *out)
{
  __m128i si128; // xmm3
  __m128 v3; // xmm2
  __m128 v4; // xmm1
  ...
  si128 = _mm_load_si128(in);
  v3 = (__m128)_mm_srli_epi32(_mm_slli_epi32(si128, 1u), 1u);
  v4 = _mm_max_ps(_mm_shuffle_ps(v3, v3, 78), v3);
  v5 = (unsigned __int8)hkVector4Comparison_maskToLastIndex[_mm_movemask_ps(
                                                              _mm_cmple_ps(
                                                                _mm_max_ps(v4, _mm_shuffle_ps(v4, v4, 177)),
                                                                v3))];
  v6 = _mm_mul_ps(_mm_shuffle_ps((__m128)LODWORD(FLOAT_2894_8953), (__m128)LODWORD(FLOAT_2894_8953), 0), (__m128)si128);
  v7 = _mm_add_epi32(
         _mm_xor_si128(
           (__m128i)_mm_cmple_ps(*(__m128 *)`hkIntVector::setConvertF32toS32::`2::two31, v6),
           _mm_cvttps_epi32(v6)),
         (__m128i)_xmm);
  v14 = _mm_packs_epi32(v7, v7);
  v8 = ((v5 == 0) + 1 == v5) + (v5 == 0) + 1;
  v9 = v14.m128i_i16[v8];
  LOWORD(v8) = v14.m128i_i16[v8 + 1 + (unsigned __int64)(v8 + 1 == v5)];
  v10 = (__m128)`hkVector4f::getComponent::`2::indexToMask[v5];
  v11 = v14.m128i_i16[v5 == 0] >> 8;
  *out = v14.m128i_i16[v5 == 0];
  v12 = _mm_and_ps(v10, (__m128)si128);
  out[3] = v8;
  out[2] = v9 >> 4;
  v13 = _mm_or_ps(_mm_shuffle_ps(v12, v12, 78), v12);
  out[1] = (16 * v9) | v11;
  out[4] = BYTE1(v8) | (16
                      * (v5 | (4 * (COERCE_FLOAT(_mm_shuffle_ps(v13, v13, 177).m128_u32[0] | v13.m128_i32[0]) < 0.0))));
}

// File Line: 398
// RVA: 0xBAB240
void __fastcall hkaSignedQuaternion::packSignedQuaternion48(const __m128i *in, char *out8)
{
  __m128i si128; // xmm3
  __m128 v4; // xmm2
  __m128 v5; // xmm1
  ...
  si128 = _mm_load_si128(in);
  v4 = (__m128)_mm_srli_epi32(_mm_slli_epi32(si128, 1u), 1u);
  ...
  v6 = (unsigned __int8)hkVector4Comparison_maskToLastIndex[_mm_movemask_ps(
                                                              _mm_cmple_ps(
                                                                ...
                                                                v4))];
  v7 = _mm_mul_ps(_mm_shuffle_ps((__m128)LODWORD(FLOAT_23169_061), (__m128)LODWORD(FLOAT_23169_061), 0), (__m128)si128);
  v8 = _mm_add_epi32(
         _mm_xor_si128(
           (__m128i)_mm_cmple_ps(*(__m128 *)`hkIntVector::setConvertF32toS32::`2::two31, v7),
           _mm_cvttps_epi32(v7)),
         (__m128i)_xmm);
  v14 = _mm_packs_epi32(v8, v8);
  v9 = ((v6 == 0) + 1 == v6) + (v6 == 0) + 1;
  v10 = v14.m128i_i16[v9];
  v11 = (__m128)`hkVector4f::getComponent::`2::indexToMask[v6];
  *(_WORD *)out8 = v14.m128i_i16[v6 == 0] | ((_WORD)v6 << 15);
  *((_WORD *)out8 + 1) = v10 | ((v6 & 0xFFFE) << 14);
  v12 = _mm_and_ps(v11, (__m128)si128);
  v13 = _mm_or_ps(_mm_shuffle_ps(v12, v12, 78), v12);
  *((_WORD *)out8 + 2) = v14.m128i_i16[v9 + 1 + (unsigned __int64)(v9 + 1 == v6)] | ((COERCE_FLOAT(_mm_shuffle_ps(
                                                                                                     v13,
                                                                                                     v13,
                                                                                                     177).m128_u32[0] | v13.m128_i32[0]) < 0.0) << 15);
}

// File Line: 465
// RVA: 0xBAB380
void __fastcall hkaSignedQuaternion::packSignedQuaternion128(hkQuaternionf *in, hkQuaternionf *out8)
{
  *out8 = (hkQuaternionf)in->m_vec.m_quad;
}
         ...
         _mm_sub_ps(
           _mm_cvtepi32_ps(
             _mm_unpacklo_epi32(
               ...
               _mm_unpacklo_epi32(
                 _mm_cvtsi32_si128(*(unsigned __int8 *)in >> 4),
                 _mm_cvtsi32_si128(*((unsigned __int8 *)in + 1) >> 4)))),
...
void __fastcall hkaSignedQuaternion::unpackSignedQuaternion24(const char *in, hkQuaternionf *out)
{
  ...
  v7 = v4 & 0x7F;
  v8 = ((v3 >> 1) | v4 & 0x80) >> 6;
  si128.m128i_i32[v8 == 0] = v3 & 0x7F;
  v9 = ((v8 == 0) + 1 == v8) + (v8 == 0) + 1;
  si128.m128i_i32[v9] = v7;
  si128.m128i_i32[v9 + 1 + (unsigned __int64)(v9 + 1 == v8)] = v5 & 0x7F;
  v10 = _mm_mul_ps(
          _mm_sub_ps(
            _mm_cvtepi32_ps(si128),
            _mm_shuffle_ps((__m128)LODWORD(FLOAT_63_0), (__m128)LODWORD(FLOAT_63_0), 0)),
  ...
  v14 = _mm_andnot_ps(_mm_cmple_ps(v13, (__m128)0i64), _mm_mul_ps(_mm_rsqrt_ps(v13), v13));
  if ( v5 < 0 )
    v14 = _mm_sub_ps((__m128)0i64, v14);
  out->m_vec.m_quad = _mm_or_ps(
...
void __fastcall hkaSignedQuaternion::unpackSignedQuaternion32(const char *in8, hkQuaternionf *out)
{
  ...
  v11 = _mm_cvtsi128_si32(_mm_cvttps_epi32(_mm_andnot_ps(_mm_cmple_ps(v10, (__m128)0i64), _mm_sqrt_ps(v10))));
  ...
  v33 = _mm_mul_ps(
          ...
          _mm_andnot_ps(_mm_cmple_ps(v32, (__m128)0i64), _mm_mul_ps(_mm_rsqrt_ps(v32), v32)));
...
// File Line: 717
// RVA: 0xBAB850
void __fastcall hkaSignedQuaternion::unpackSignedQuaternion40(const __m128i *in, hkQuaternionf *out)
{
  __m128i v2; // xmm6
  __int64 v4; // rdx
  __m128 v5; // xmm3
  ...
  __m128i v23; // [rsp+10h] [rbp-28h] BYREF

  v2 = _mm_loadl_epi64(in);
  v4 = 0i64;
  v22 = v2;
  ...
  do
  {
    ...
    v22.m128i_i8[v4 + 12] = v8;
    v10 = v22.m128i_i8[v9];
    v11 = (unsigned __int8)permBytes[v4 - 2];
    v22.m128i_i8[v4 + 13] = v10;
    v12 = v22.m128i_i8[v11];
    v13 = (unsigned __int8)permBytes[v4 - 1];
    v22.m128i_i8[v4 + 14] = v12;
    v22.m128i_i8[v4 + 15] = v22.m128i_i8[v13];
  }
  while ( v4 < 16 );
  v14 = _mm_mul_ps(
          _mm_sub_ps(
  ...
  v19 = _mm_xor_ps(
          (__m128)_mm_slli_epi32(
                    _mm_srli_epi32(
                      ...
                      0x1Fu),
                    0x1Fu),
          _mm_andnot_ps(_mm_cmple_ps(v17, (__m128)0i64), _mm_mul_ps(_mm_rsqrt_ps(v17), v17)));
  if ( v18 )
  {
    switch ( v18 )
    {
      case 16:
        ...
        out->m_vec.m_quad = _mm_shuffle_ps(_mm_unpacklo_ps(v21, v19), v21, 228);
        return;
      case 32:
        v20 = _mm_shuffle_ps(v14, v14, 180);
        out->m_vec.m_quad = _mm_shuffle_ps(v20, _mm_unpackhi_ps(v20, v19), 180);
        return;
      case 48:
        out->m_vec.m_quad = _mm_shuffle_ps(v14, _mm_unpackhi_ps(v14, v19), 196);
        return;
    }
  }
  else
...
void __fastcall hkaSignedQuaternion::unpackSignedQuaternion48(const char *in8, hkQuaternionf *out)
{
  ...
  si128.m128i_i32[v7 == 0] = v5 & 0x7FFF;
  v8 = ((v7 == 0) + 1 == v7) + (v7 == 0) + 1;
  si128.m128i_i32[v8] = v6;
  si128.m128i_i32[v8 + 1 + (unsigned __int64)(v8 + 1 == v7)] = v3 & 0x7FFF;
  v9 = _mm_mul_ps(
         _mm_sub_ps(
           _mm_cvtepi32_ps(si128),
  ...
  v13 = _mm_andnot_ps(_mm_cmple_ps(v12, (__m128)0i64), _mm_mul_ps(_mm_rsqrt_ps(v12), v12));
  if ( v3 < 0 )
...
// File Line: 1253
// RVA: 0xBABB70
void __fastcall hkaSignedQuaternion::unpackSignedQuaternion128(hkQuaternionf *in8, hkQuaternionf *out)
{
  *out = (hkQuaternionf)in8->m_vec.m_quad;
}
...
void __fastcall hkaSignedQuaternion::handleEndianSignedQuaternion128(char *dataInOut)
{
  ...
  *dataInOut = dataInOut[3];
  ...
  dataInOut[2] = v3;
  v4 = dataInOut[4];
  dataInOut[4] = dataInOut[7];
  dataInOut[7] = v4;
  v5 = dataInOut[5];
  dataInOut[5] = dataInOut[6];
  dataInOut[6] = v5;
  v6 = dataInOut[8];
  dataInOut[8] = dataInOut[11];
  dataInOut[11] = v6;
  v7 = dataInOut[9];
  dataInOut[9] = dataInOut[10];
  dataInOut[10] = v7;
  v8 = dataInOut[12];
  dataInOut[12] = dataInOut[15];
  dataInOut[15] = v8;
  v9 = dataInOut[13];
  dataInOut[13] = dataInOut[14];
  dataInOut[14] = v9;
}
...
// File Line: 1364
// RVA: 0xBAAAC0
const char *__fastcall hkaCompression::computePackedNurbsOffsets(
        const char *base,
        const unsigned int *m_blockOffsets,
        unsigned int block,
        unsigned int maskAndQuantizationSize)
{
  __int64 v5; // rdi
  __int64 v9; // rax
  ...
  v9 = maskAndQuantizationSize;
  LODWORD(v9) = maskAndQuantizationSize & 0x7FFFFFFF;
  return &base[m_blockOffsets[v5] + v9];
}
